...
int main(void){
   ...
   7:	83 e4 f0             	and    $0xfffffff0,%esp
	sdebug_func();
   a:	e8 11 00 00 00       	call   20 <sdebug_func>
	exit();
...
void sdebug_func(void){
  2b:	53                   	push   %ebx
  2c:	83 ec 14             	sub    $0x14,%esp
	printf(1,"start sdebug command\n");
  2f:	68 88 08 00 00       	push   $0x888
  34:	6a 01                	push   $0x1
  36:	e8 e5 04 00 00       	call   520 <printf>
  3b:	83 c4 10             	add    $0x10,%esp
		pid = fork();
  3e:	e8 68 03 00 00       	call   3ab <fork>
		if(pid<0)
  43:	85 c0                	test   %eax,%eax
  45:	78 15                	js     5c <sdebug_func+0x3c>
		if(pid==0){
  47:	8d 5e 01             	lea    0x1(%esi),%ebx
  4a:	74 52                	je     9e <sdebug_func+0x7e>
	for(n=0; n<PNUM; n++){
  4c:	83 fb 05             	cmp    $0x5,%ebx
  4f:	74 17                	je     68 <sdebug_func+0x48>
  51:	89 de                	mov    %ebx,%esi
		pid = fork();
  53:	e8 53 03 00 00       	call   3ab <fork>
		if(pid<0)
  58:	85 c0                	test   %eax,%eax
  5a:	79 eb                	jns    47 <sdebug_func+0x27>
	for(; n > 0; n--){
  5c:	89 f3                	mov    %esi,%ebx
  5e:	85 f6                	test   %esi,%esi
  60:	74 14                	je     76 <sdebug_func+0x56>
  62:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		if(wait() < 0){
  68:	e8 4e 03 00 00       	call   3bb <wait>
  6d:	85 c0                	test   %eax,%eax
  6f:	78 5f                	js     d0 <sdebug_func+0xb0>
	for(; n > 0; n--){
  71:	83 eb 01             	sub    $0x1,%ebx
  74:	75 f2                	jne    68 <sdebug_func+0x48>
	if(wait() != -1){
  76:	e8 40 03 00 00       	call   3bb <wait>
  7b:	83 f8 ff             	cmp    $0xffffffff,%eax
  7e:	0f 85 a4 00 00 00    	jne    128 <sdebug_func+0x108>
	printf(1,"end of sdebug command\n");
  84:	83 ec 08             	sub    $0x8,%esp
  87:	68 c5 08 00 00       	push   $0x8c5
  8c:	6a 01                	push   $0x1
  8e:	e8 8d 04 00 00       	call   520 <printf>
	return;
  ...
  9e:	e8 a8 03 00 00       	call   44b <uptime>
			if(weightset(n+1)==-1){
  ...
  a7:	89 c7                	mov    %eax,%edi
			if(weightset(n+1)==-1){
  a9:	e8 a5 03 00 00       	call   453 <weightset>
  ae:	83 c4 10             	add    $0x10,%esp
  b1:	83 f8 ff             	cmp    $0xffffffff,%eax
  b4:	75 2e                	jne    e4 <sdebug_func+0xc4>
				printf(2,"Error, use weight bigger than 0!\n");
  b6:	83 ec 08             	sub    $0x8,%esp
	for(; n > 0; n--){
  b9:	89 f3                	mov    %esi,%ebx
				printf(2,"Error, use weight bigger than 0!\n");
  bb:	68 dc 08 00 00       	push   $0x8dc
  c0:	6a 02                	push   $0x2
  c2:	e8 59 04 00 00       	call   520 <printf>
				break;
  c7:	83 c4 10             	add    $0x10,%esp
	for(; n > 0; n--){
  ca:	85 f6                	test   %esi,%esi
  cc:	75 9a                	jne    68 <sdebug_func+0x48>
  ce:	eb a6                	jmp    76 <sdebug_func+0x56>
			printf(1,"wait stopped early\n");
  d0:	83 ec 08             	sub    $0x8,%esp
  d3:	68 9e 08 00 00       	push   $0x89e
  d8:	6a 01                	push   $0x1
  da:	e8 41 04 00 00       	call   520 <printf>
			exit();
  df:	e8 cf 02 00 00       	call   3b3 <exit>
	count=0;
  e4:	31 db                	xor    %ebx,%ebx
  e6:	31 f6                	xor    %esi,%esi
  e8:	eb 18                	jmp    102 <sdebug_func+0xe2>
  ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
				if(count>=TOTAL_COUNTER){ 
  f0:	89 da                	mov    %ebx,%edx
  f2:	81 f2 00 65 cd 1d    	xor    $0x1dcd6500,%edx
  f8:	09 d0                	or     %edx,%eax
  fa:	74 3f                	je     13b <sdebug_func+0x11b>
				count++; //count cycles(p3)
  fc:	83 c3 01             	add    $0x1,%ebx
  ff:	83 d6 00             	adc    $0x0,%esi
				if(count==PRINT_CYCLE){
 102:	89 da                	mov    %ebx,%edx
 104:	89 f0                	mov    %esi,%eax
 106:	81 f2 00 e1 f5 05    	xor    $0x5f5e100,%edx
 10c:	09 f2                	or     %esi,%edx
 10e:	75 e0                	jne    f0 <sdebug_func+0xd0>
					currTick = uptime()-prevTick; //save current uptime til this process information printed(p3)
 110:	e8 36 03 00 00       	call   44b <uptime>
					printProcInfo(currTick*10); //print current process information by system call(p3)
 115:	83 ec 0c             	sub    $0xc,%esp
					currTick = uptime()-prevTick; //save current uptime til this process information printed(p3)
 118:	29 f8                	sub    %edi,%eax
					printProcInfo(currTick*10); //print current process information by system call(p3)
 11a:	6b c0 0a             	imul   $0xa,%eax,%eax
 11d:	50                   	push   %eax
 11e:	e8 38 03 00 00       	call   45b <printProcInfo>
 123:	83 c4 10             	add    $0x10,%esp
 126:	eb d4                	jmp    fc <sdebug_func+0xdc>
		printf(1,"wait got too many\n");
 128:	50                   	push   %eax
 129:	50                   	push   %eax
 12a:	68 b2 08 00 00       	push   $0x8b2
 12f:	6a 01                	push   $0x1
 131:	e8 ea 03 00 00       	call   520 <printf>
		exit();
 136:	e8 78 02 00 00       	call   3b3 <exit>
					printTerminated(); //print that current process terminated by system call(p3)
 13b:	e8 23 03 00 00       	call   463 <printTerminated>
...
00000453 <weightset>:
SYSCALL(weightset) //syscall weightset(p3)
 453:	b8 16 00 00 00       	mov    $0x16,%eax
 458:	cd 40                	int    $0x40
 45a:	c3                   	ret    

0000045b <printProcInfo>:
SYSCALL(printProcInfo) //syscall printProcInfo(p3)
 45b:	b8 17 00 00 00       	mov    $0x17,%eax
 460:	cd 40                	int    $0x40
 462:	c3                   	ret    

00000463 <printTerminated>:
SYSCALL(printTerminated) //syscall printTerminated(p3)
...
printf(int fd, const char *fmt, ...)
{
 ...
 6a4:	eb 1a                	jmp    6c0 <printf+0x1a0>
          s = "(null)";
 6a6:	bb fe 08 00 00       	mov    $0x8fe,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f5:	a1 d8 0b 00 00       	mov    0xbd8,%eax
{
 ...
 716:	73 10                	jae    728 <free+0x38>
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	a3 d8 0b 00 00       	mov    %eax,0xbd8
}
 747:	5e                   	pop    %esi
 748:	5f                   	pop    %edi
 749:	5d                   	pop    %ebp
 ...
 767:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 76a:	a3 d8 0b 00 00       	mov    %eax,0xbd8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 78d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 790:	8b 3d d8 0b 00 00    	mov    0xbd8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7d9:	8b 3d d8 0b 00 00    	mov    0xbd8,%edi
 ...
 802:	e8 e9 fe ff ff       	call   6f0 <free>
  return freep;
 807:	a1 d8 0b 00 00       	mov    0xbd8,%eax
 ...
 834:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 837:	a3 d8 0b 00 00       	mov    %eax,0xbd8
}
 ...
 84e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 d8 0b 00 00 dc 	movl   $0xbdc,0xbd8
 857:	0b 00 00 
    base.s.size = 0;
 85a:	bf dc 0b 00 00       	mov    $0xbdc,%edi
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 dc 0b 00 00 dc 	movl   $0xbdc,0xbdc
 866:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 869:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 86b:	c7 05 e0 0b 00 00 00 	movl   $0x0,0xbe0
 872:	00 00 00 
    if(p->s.size >= nunits){
