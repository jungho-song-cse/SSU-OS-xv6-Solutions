...
8010005a:	e8 f1 44 00 00       	call   80104550 <initlock>
  bcache.head.next = &bcache.head;
...
801000e8:	e8 e3 45 00 00       	call   801046d0 <acquire>
...
801001c2:	e8 29 43 00 00       	call   801044f0 <holdingsleep>
...
80100203:	e8 e8 42 00 00       	call   801044f0 <holdingsleep>
...
80100213:	e8 98 42 00 00       	call   801044b0 <releasesleep>

  acquire(&bcache.lock);
80100218:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
8010021f:	e8 ac 44 00 00       	call   801046d0 <acquire>
  b->refcnt--;
...
8010026f:	5d                   	pop    %ebp
  release(&bcache.lock);
80100270:	e9 1b 45 00 00       	jmp    80104790 <release>
    panic("brelse");
...
801002b1:	e8 1a 44 00 00       	call   801046d0 <acquire>
...
8010030e:	e8 7d 44 00 00       	call   80104790 <release>
        ilock(ip);
80100313:	5a                   	pop    %edx
...
80100365:	e8 26 44 00 00       	call   80104790 <release>
  ilock(ip);
8010036a:	58                   	pop    %eax
...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 37 7d 10 80 	movl   $0x80107d37,(%esp)
...
801003dc:	e8 8f 41 00 00       	call   80104570 <getcallerpcs>
  for(i=0; i<10; i++)
...
8010042a:	e8 01 5b 00 00       	call   80105f30 <uartputc>
...
80100515:	e8 16 5a 00 00       	call   80105f30 <uartputc>
8010051a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100521:	e8 0a 5a 00 00       	call   80105f30 <uartputc>
80100526:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010052d:	e8 fe 59 00 00       	call   80105f30 <uartputc>
...
80100576:	e8 65 42 00 00       	call   801047e0 <memset>
...
8010065f:	e8 6c 40 00 00       	call   801046d0 <acquire>
  for(i = 0; i < n; i++)
...
80100697:	e8 f4 40 00 00       	call   80104790 <release>
  ilock(ip);
8010069c:	58                   	pop    %eax
...
801007bd:	e8 0e 3f 00 00       	call   801046d0 <acquire>
...
80100828:	e8 63 3f 00 00       	call   80104790 <release>
...
80100877:	e8 54 3e 00 00       	call   801046d0 <acquire>
  while((c = getc()) >= 0){
...
801009cf:	e8 bc 3d 00 00       	call   80104790 <release>
  if(doprocdump) {
...
80100a44:	e8 07 3b 00 00       	call   80104550 <initlock>
...
80100b0a:	75 ce                	jne    80100ada <exec+0x5a>
  if((pgdir = setupkvm()) == 0)
80100b0c:	e8 8f 65 00 00       	call   801070a0 <setupkvm>
...
80100b73:	e8 48 63 00 00       	call   80106ec0 <allocuvm>
...
80100ba9:	e8 42 62 00 00       	call   80106df0 <loaduvm>
...
80100beb:	e8 30 64 00 00       	call   80107020 <freevm>
  if(ip){
...
80100c32:	e8 89 62 00 00       	call   80106ec0 <allocuvm>
...
80100c51:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c53:	e8 e8 64 00 00       	call   80107140 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100ca3:	e8 38 3d 00 00       	call   801049e0 <strlen>
...
80100cb6:	e8 25 3d 00 00       	call   801049e0 <strlen>
...
80100ce1:	e8 3a 63 00 00       	call   80107020 <freevm>
...
80100d2d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d33:	e8 68 65 00 00       	call   801072a0 <copyout>
...
80100d71:	e8 2a 3c 00 00       	call   801049a0 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d9d:	e8 be 5e 00 00       	call   80106c60 <switchuvm>
  freevm(oldpgdir);
80100da2:	89 3c 24             	mov    %edi,(%esp)
80100da5:	e8 76 62 00 00       	call   80107020 <freevm>
  return 0;
...
80100df4:	e8 57 37 00 00       	call   80104550 <initlock>
}
...
80100e15:	e8 b6 38 00 00       	call   801046d0 <acquire>
...
80100e41:	e8 4a 39 00 00       	call   80104790 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e5a:	e8 31 39 00 00       	call   80104790 <release>
}
...
80100e83:	e8 48 38 00 00       	call   801046d0 <acquire>
  if(f->ref < 1)
...
80100ea0:	e8 eb 38 00 00       	call   80104790 <release>
  return f;
}
...
80100ed5:	e8 f6 37 00 00       	call   801046d0 <acquire>
  if(f->ref < 1)
...
80100f0d:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f10:	e8 7b 38 00 00       	call   80104790 <release>
...
80100f3d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f3e:	e9 4d 38 00 00       	jmp    80104790 <release>
...
80101217:	68 ff 73 10 80       	push   $0x801073ff
...
801012d4:	68 12 74 10 80       	push   $0x80107412
...
80101315:	e8 c6 34 00 00       	call   801047e0 <memset>
  log_write(bp);
...
801013c7:	e8 c4 33 00 00       	call   80104790 <release>
...
801013f2:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801013f5:	e8 96 33 00 00       	call   80104790 <release>
      return ip;
...
80101422:	68 28 74 10 80       	push   $0x80107428
...
801014eb:	68 38 74 10 80       	push   $0x80107438
...
80101525:	e8 56 33 00 00       	call   80104880 <memmove>
  brelse(bp);
...
8010155a:	e8 f1 2f 00 00       	call   80104550 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101577:	e8 94 2e 00 00       	call   80104410 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
8010165e:	e8 7d 31 00 00       	call   801047e0 <memset>
      dip->type = type;
...
80101705:	e8 76 31 00 00       	call   80104880 <memmove>
  log_write(bp);
...
80101743:	e8 88 2f 00 00       	call   801046d0 <acquire>
  ip->ref++;
80101748:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010174c:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101753:	e8 38 30 00 00       	call   80104790 <release>
}
...
80101786:	e8 c5 2c 00 00       	call   80104450 <acquiresleep>
  if(ip->valid == 0){
...
801017f8:	e8 83 30 00 00       	call   80104880 <memmove>
    brelse(bp);
...
80101857:	e8 94 2c 00 00       	call   801044f0 <holdingsleep>
...
80101872:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
80101873:	e9 38 2c 00 00       	jmp    801044b0 <releasesleep>
    panic("iunlock");
...
801018a4:	e8 a7 2b 00 00       	call   80104450 <acquiresleep>
...
801018be:	e8 ed 2b 00 00       	call   801044b0 <releasesleep>
  acquire(&icache.lock);
801018c3:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801018ca:	e8 01 2e 00 00       	call   801046d0 <acquire>
  ip->ref--;
...
801018e3:	5d                   	pop    %ebp
  release(&icache.lock);
801018e4:	e9 a7 2e 00 00       	jmp    80104790 <release>
801018e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    acquire(&icache.lock);
801018f0:	83 ec 0c             	sub    $0xc,%esp
801018f3:	68 e0 09 11 80       	push   $0x801109e0
801018f8:	e8 d3 2d 00 00       	call   801046d0 <acquire>
    int r = ip->ref;
801018fd:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101900:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101907:	e8 84 2e 00 00       	call   80104790 <release>
    if(r == 1){
...
80101b07:	e8 74 2d 00 00       	call   80104880 <memmove>
    brelse(bp);
...
80101c03:	e8 78 2c 00 00       	call   80104880 <memmove>
    log_write(bp);
...
80101ca2:	e8 49 2c 00 00       	call   801048f0 <strncmp>
}
80101ca7:	c9                   	leave  
80101ca8:	c3                   	ret    
...
80101d05:	e8 e6 2b 00 00       	call   801048f0 <strncmp>
      continue;
...
80101d9c:	e8 2f 29 00 00       	call   801046d0 <acquire>
  ip->ref++;
80101da1:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101da5:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101dac:	e8 df 29 00 00       	call   80104790 <release>
...
80101e17:	e8 64 2a 00 00       	call   80104880 <memmove>
...
80101ea3:	e8 d8 29 00 00       	call   80104880 <memmove>
    name[len] = 0;
...
80101fd5:	e8 66 29 00 00       	call   80104940 <strncpy>
...
80102020:	68 ca 7a 10 80       	push   $0x80107aca
...
80102164:	e8 e7 23 00 00       	call   80104550 <initlock>
...
801021f2:	e8 d9 24 00 00       	call   801046d0 <acquire>
...
8010226b:	e8 20 25 00 00       	call   80104790 <release>
...
80102292:	e8 59 22 00 00       	call   801044f0 <holdingsleep>
...
801022cc:	e8 ff 23 00 00       	call   801046d0 <acquire>
...
80102335:	c9                   	leave  
  release(&idelock);
80102336:	e9 55 24 00 00       	jmp    80104790 <release>
...
801024a6:	e8 35 23 00 00       	call   801047e0 <memset>
...
801024e0:	e8 eb 21 00 00       	call   801046d0 <acquire>
...
801024fa:	c9                   	leave  
    release(&kmem.lock);
801024fb:	e9 90 22 00 00       	jmp    80104790 <release>
    panic("kfree");
...
80102579:	e8 d2 1f 00 00       	call   80104550 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102663:	e8 68 20 00 00       	call   801046d0 <acquire>
  r = kmem.freelist;
...
80102691:	e8 fa 20 00 00       	call   80104790 <release>
  return (char*)r;
...
80102abf:	e8 6c 1d 00 00       	call   80104830 <memcmp>
...
80102bf4:	e8 87 1c 00 00       	call   80104880 <memmove>
...
80102ca8:	e8 a3 18 00 00       	call   80104550 <initlock>
  readsb(dev, &sb);
80102cad:	58                   	pop    %eax
...
80102d3f:	e8 8c 19 00 00       	call   801046d0 <acquire>
...
80102d94:	e8 f7 19 00 00       	call   80104790 <release>
      break;
    }
  }
}
...
80102db2:	e8 19 19 00 00       	call   801046d0 <acquire>
  log.outstanding -= 1;
...
80102df0:	e8 9b 19 00 00       	call   80104790 <release>
}
...
80102e0a:	e8 c1 18 00 00       	call   801046d0 <acquire>
    wakeup(&log);
...
80102e2c:	e8 5f 19 00 00       	call   80104790 <release>
...
80102e84:	e8 f7 19 00 00       	call   80104880 <memmove>
...
80102ee4:	e8 a7 18 00 00       	call   80104790 <release>
...
80102f52:	e8 79 17 00 00       	call   801046d0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102f94:	c9                   	leave  
  release(&log.lock);
80102f95:	e9 f6 17 00 00       	jmp    80104790 <release>
...
80103002:	e8 69 2b 00 00       	call   80105b70 <idtinit>
...
80103027:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
8010302a:	e8 11 3c 00 00       	call   80106c40 <switchkvm>
  seginit();
8010302f:	e8 7c 3b 00 00       	call   80106bb0 <seginit>
  lapicinit();
...
80103065:	e8 b6 40 00 00       	call   80107120 <kvmalloc>
  mpinit();        // detect other processors
8010306a:	e8 81 01 00 00       	call   801031f0 <mpinit>
  lapicinit();     // interrupt controller
8010306f:	e8 2c f7 ff ff       	call   801027a0 <lapicinit>
  seginit();       // segment descriptors
80103074:	e8 37 3b 00 00       	call   80106bb0 <seginit>
  picinit();       // disable pic
...
80103088:	e8 e3 2d 00 00       	call   80105e70 <uartinit>
  pinit();         // process table
8010308d:	e8 4e 08 00 00       	call   801038e0 <pinit>
  tvinit();        // trap vectors
80103092:	e8 59 2a 00 00       	call   80105af0 <tvinit>
  binit();         // buffer cache
...
801030b8:	e8 c3 17 00 00       	call   80104880 <memmove>
...
8010319e:	68 38 78 10 80       	push   $0x80107838
801031a3:	56                   	push   %esi
801031a4:	e8 87 16 00 00       	call   80104830 <memcmp>
...
8010325a:	68 3d 78 10 80       	push   $0x8010783d
8010325f:	50                   	push   %eax
  conf = (struct mpconf*) P2V((uint) mp->physaddr);
80103260:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103263:	e8 c8 15 00 00       	call   80104830 <memcmp>
...
801033b3:	68 42 78 10 80       	push   $0x80107842
801033b8:	e8 d3 cf ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
801033bd:	83 ec 0c             	sub    $0xc,%esp
801033c0:	68 5c 78 10 80       	push   $0x8010785c
...
80103464:	00 00 00 
  initlock(&p->lock, "pipe");
80103467:	68 7b 78 10 80       	push   $0x8010787b
8010346c:	50                   	push   %eax
8010346d:	e8 de 10 00 00       	call   80104550 <initlock>
  (*f0)->type = FD_PIPE;
...
80103513:	e8 b8 11 00 00       	call   801046d0 <acquire>
  if(writable){
...
80103557:	5d                   	pop    %ebp
    release(&p->lock);
80103558:	e9 33 12 00 00       	jmp    80104790 <release>
...
80103584:	e8 07 12 00 00       	call   80104790 <release>
    kfree((char*)p);
...
801035b1:	e8 1a 11 00 00       	call   801046d0 <acquire>
  for(i = 0; i < n; i++){
...
8010363c:	e8 4f 11 00 00       	call   80104790 <release>
        return -1;
...
80103692:	e8 f9 10 00 00       	call   80104790 <release>
  return n;
...
801036ba:	e8 11 10 00 00       	call   801046d0 <acquire>
...
8010375e:	e8 2d 10 00 00       	call   80104790 <release>
  return i;
...
80103779:	e8 12 10 00 00       	call   80104790 <release>
      return -1;
...
801037a1:	e8 2a 0f 00 00       	call   801046d0 <acquire>
...
801037ce:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->weight = weight++; //save weight +1 (p3)
  p->priority = ptable.minPriority; //set new process priority with minPriority (p3)
...
801037db:	8d 50 01             	lea    0x1(%eax),%edx
  p->weight = weight++; //save weight +1 (p3)
801037de:	a1 04 a0 10 80       	mov    0x8010a004,%eax
  p->pid = nextpid++;
801037e3:	89 15 08 a0 10 80    	mov    %edx,0x8010a008
  p->weight = weight++; //save weight +1 (p3)
801037e9:	8d 50 01             	lea    0x1(%eax),%edx
801037ec:	89 83 84 00 00 00    	mov    %eax,0x84(%ebx)
  p->priority = ptable.minPriority; //set new process priority with minPriority (p3)
801037f2:	a1 54 4f 11 80       	mov    0x80114f54,%eax
  p->weight = weight++; //save weight +1 (p3)
801037f7:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  p->priority = ptable.minPriority; //set new process priority with minPriority (p3)
801037fd:	8b 15 58 4f 11 80    	mov    0x80114f58,%edx
80103803:	89 43 7c             	mov    %eax,0x7c(%ebx)
80103806:	89 93 80 00 00 00    	mov    %edx,0x80(%ebx)
  release(&ptable.lock);
8010380c:	68 20 2d 11 80       	push   $0x80112d20
80103811:	e8 7a 0f 00 00       	call   80104790 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80103816:	e8 15 ee ff ff       	call   80102630 <kalloc>
8010381b:	83 c4 10             	add    $0x10,%esp
8010381e:	89 43 08             	mov    %eax,0x8(%ebx)
80103821:	85 c0                	test   %eax,%eax
80103823:	74 54                	je     80103879 <allocproc+0xe9>
    return 0;
  }
  ...
  sp -= sizeof *p->tf;
80103825:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  sp -= 4;
...
8010382b:	83 ec 04             	sub    $0x4,%esp
  sp -= sizeof *p->context;
8010382e:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
80103833:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103836:	c7 40 14 db 5a 10 80 	movl   $0x80105adb,0x14(%eax)
  p->context = (struct context*)sp;
8010383d:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103840:	6a 14                	push   $0x14
80103842:	6a 00                	push   $0x0
80103844:	50                   	push   %eax
80103845:	e8 96 0f 00 00       	call   801047e0 <memset>
  p->context->eip = (uint)forkret;
8010384a:	8b 43 1c             	mov    0x1c(%ebx),%eax

  return p;
8010384d:	83 c4 10             	add    $0x10,%esp
  p->context->eip = (uint)forkret;
80103850:	c7 40 10 90 38 10 80 	movl   $0x80103890,0x10(%eax)
}
...
8010386a:	e8 21 0f 00 00       	call   80104790 <release>
}
...
8010389f:	e8 ec 0e 00 00       	call   80104790 <release>
...
801038ea:	68 80 78 10 80       	push   $0x80107880
801038ef:	68 20 2d 11 80       	push   $0x80112d20
801038f4:	e8 57 0c 00 00       	call   80104550 <initlock>
}
...
80103998:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010399b:	e8 30 0c 00 00       	call   801045d0 <pushcli>
  c = mycpu();
801039a0:	e8 5b ff ff ff       	call   80103900 <mycpu>
  p = c->proc;
801039a5:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039ab:	e8 70 0c 00 00       	call   80104620 <popcli>
}
...
801039c8:	83 ec 04             	sub    $0x4,%esp
  ptable.minPriority = 3; //set init priority to 3 (p3)
801039cb:	c7 05 54 4f 11 80 03 	movl   $0x3,0x80114f54
801039d2:	00 00 00 
801039d5:	c7 05 58 4f 11 80 00 	movl   $0x0,0x80114f58
801039dc:	00 00 00 
  p = allocproc();
801039df:	e8 ac fd ff ff       	call   80103790 <allocproc>
801039e4:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039e6:	a3 b8 a5 10 80       	mov    %eax,0x8010a5b8
  if((p->pgdir = setupkvm()) == 0)
801039eb:	e8 b0 36 00 00       	call   801070a0 <setupkvm>
801039f0:	89 43 04             	mov    %eax,0x4(%ebx)
801039f3:	85 c0                	test   %eax,%eax
801039f5:	0f 84 bd 00 00 00    	je     80103ab8 <userinit+0xf8>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
801039fb:	83 ec 04             	sub    $0x4,%esp
801039fe:	68 2c 00 00 00       	push   $0x2c
80103a03:	68 60 a4 10 80       	push   $0x8010a460
80103a08:	50                   	push   %eax
80103a09:	e8 62 33 00 00       	call   80106d70 <inituvm>
  memset(p->tf, 0, sizeof(*p->tf));
80103a0e:	83 c4 0c             	add    $0xc,%esp
  p->sz = PGSIZE;
80103a11:	c7 03 00 10 00 00    	movl   $0x1000,(%ebx)
  memset(p->tf, 0, sizeof(*p->tf));
80103a17:	6a 4c                	push   $0x4c
80103a19:	6a 00                	push   $0x0
80103a1b:	ff 73 18             	pushl  0x18(%ebx)
80103a1e:	e8 bd 0d 00 00       	call   801047e0 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103a23:	8b 43 18             	mov    0x18(%ebx),%eax
80103a26:	ba 1b 00 00 00       	mov    $0x1b,%edx
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103a2b:	83 c4 0c             	add    $0xc,%esp
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103a2e:	b9 23 00 00 00       	mov    $0x23,%ecx
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103a33:	66 89 50 3c          	mov    %dx,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103a37:	8b 43 18             	mov    0x18(%ebx),%eax
80103a3a:	66 89 48 2c          	mov    %cx,0x2c(%eax)
  p->tf->es = p->tf->ds;
80103a3e:	8b 43 18             	mov    0x18(%ebx),%eax
80103a41:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103a45:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
80103a49:	8b 43 18             	mov    0x18(%ebx),%eax
80103a4c:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103a50:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
80103a54:	8b 43 18             	mov    0x18(%ebx),%eax
80103a57:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80103a5e:	8b 43 18             	mov    0x18(%ebx),%eax
80103a61:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
80103a68:	8b 43 18             	mov    0x18(%ebx),%eax
80103a6b:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103a72:	8d 43 6c             	lea    0x6c(%ebx),%eax
80103a75:	6a 10                	push   $0x10
80103a77:	68 b0 78 10 80       	push   $0x801078b0
80103a7c:	50                   	push   %eax
80103a7d:	e8 1e 0f 00 00       	call   801049a0 <safestrcpy>
  p->cwd = namei("/");
80103a82:	c7 04 24 b9 78 10 80 	movl   $0x801078b9,(%esp)
80103a89:	e8 a2 e5 ff ff       	call   80102030 <namei>
80103a8e:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103a91:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a98:	e8 33 0c 00 00       	call   801046d0 <acquire>
  p->state = RUNNABLE;
80103a9d:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103aa4:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103aab:	e8 e0 0c 00 00       	call   80104790 <release>
}
...
80103abb:	68 97 78 10 80       	push   $0x80107897
...
80103ad9:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103adc:	e8 ef 0a 00 00       	call   801045d0 <pushcli>
  c = mycpu();
80103ae1:	e8 1a fe ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103ae6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103aec:	e8 2f 0b 00 00       	call   80104620 <popcli>
  sz = curproc->sz;
...
80103aff:	e8 5c 31 00 00       	call   80106c60 <switchuvm>
  return 0;
...
80103b5a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b5d:	e8 6e 0a 00 00       	call   801045d0 <pushcli>
  c = mycpu();
80103b62:	e8 99 fd ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103b67:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b6d:	e8 ae 0a 00 00       	call   80104620 <popcli>
  if((np = allocproc()) == 0){
...
80103b8c:	e8 df 35 00 00       	call   80107170 <copyuvm>
...
80103c09:	e8 92 0d 00 00       	call   801049a0 <safestrcpy>
  pid = np->pid;
...
80103c2b:	e8 60 0b 00 00       	call   80104790 <release>
  return pid;
...
80103c99:	83 ec 0c             	sub    $0xc,%esp
    minP=(struct proc*)0;//reset minP to NULL POINTER (p3)
80103c9c:	31 ff                	xor    %edi,%edi
    acquire(&ptable.lock);
80103c9e:	68 20 2d 11 80       	push   $0x80112d20
80103ca3:	e8 28 0a 00 00       	call   801046d0 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ca8:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
    acquire(&ptable.lock);
80103cab:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cae:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103cb3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103cb7:	90                   	nop
      if(p->state != RUNNABLE)
80103cb8:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103cbc:	75 28                	jne    80103ce6 <scheduler+0x76>
      if(minP!=(struct proc*)0){
80103cbe:	8b 48 7c             	mov    0x7c(%eax),%ecx
80103cc1:	8b 90 80 00 00 00    	mov    0x80(%eax),%edx
80103cc7:	85 ff                	test   %edi,%edi
80103cc9:	74 0d                	je     80103cd8 <scheduler+0x68>
        if(p->priority < minP->priority){
80103ccb:	3b 4f 7c             	cmp    0x7c(%edi),%ecx
80103cce:	89 d3                	mov    %edx,%ebx
80103cd0:	1b 9f 80 00 00 00    	sbb    0x80(%edi),%ebx
80103cd6:	7d 0e                	jge    80103ce6 <scheduler+0x76>
	ptable.minPriority = p->priority;
80103cd8:	89 0d 54 4f 11 80    	mov    %ecx,0x80114f54
80103cde:	89 c7                	mov    %eax,%edi
80103ce0:	89 15 58 4f 11 80    	mov    %edx,0x80114f58
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ce6:	05 88 00 00 00       	add    $0x88,%eax
80103ceb:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103cf0:	75 c6                	jne    80103cb8 <scheduler+0x48>
80103cf2:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
    if(p==(struct proc*)0){
80103cf5:	85 ff                	test   %edi,%edi
80103cf7:	74 7d                	je     80103d76 <scheduler+0x106>
      cprintf("PID: %d, NAME: %s, WEIGHT: %d, PRIORITY: %d\n",p->pid,p->name,p->weight,p->priority); 
80103cf9:	83 ec 08             	sub    $0x8,%esp
80103cfc:	8d 47 6c             	lea    0x6c(%edi),%eax
80103cff:	ff b7 80 00 00 00    	pushl  0x80(%edi)
80103d05:	ff 77 7c             	pushl  0x7c(%edi)
80103d08:	ff b7 84 00 00 00    	pushl  0x84(%edi)
80103d0e:	50                   	push   %eax
80103d0f:	ff 77 10             	pushl  0x10(%edi)
80103d12:	68 8c 79 10 80       	push   $0x8010798c
80103d17:	e8 94 c9 ff ff       	call   801006b0 <cprintf>
    switchuvm(p);
80103d1c:	83 c4 14             	add    $0x14,%esp
    c->proc = p;
80103d1f:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
    switchuvm(p);
80103d25:	57                   	push   %edi
80103d26:	e8 35 2f 00 00       	call   80106c60 <switchuvm>
    p->priority = p->priority + (10000000/p->weight); //update priority when scheduler called(p3)
80103d2b:	b8 80 96 98 00       	mov    $0x989680,%eax
    p->state = RUNNING;
80103d30:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
    p->priority = p->priority + (10000000/p->weight); //update priority when scheduler called(p3)
80103d37:	99                   	cltd   
80103d38:	f7 bf 84 00 00 00    	idivl  0x84(%edi)
80103d3e:	99                   	cltd   
80103d3f:	01 47 7c             	add    %eax,0x7c(%edi)
80103d42:	11 97 80 00 00 00    	adc    %edx,0x80(%edi)
    swtch(&(c->scheduler), p->context);
80103d48:	58                   	pop    %eax
80103d49:	5a                   	pop    %edx
80103d4a:	ff 77 1c             	pushl  0x1c(%edi)
80103d4d:	56                   	push   %esi
80103d4e:	e8 b0 0c 00 00       	call   80104a03 <swtch>
    switchkvm();
80103d53:	e8 e8 2e 00 00       	call   80106c40 <switchkvm>
    c->proc = 0;
80103d58:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103d5f:	00 00 00 
    release(&ptable.lock);
80103d62:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103d69:	e8 22 0a 00 00       	call   80104790 <release>
80103d6e:	83 c4 10             	add    $0x10,%esp
80103d71:	e9 22 ff ff ff       	jmp    80103c98 <scheduler+0x28>
	    release(&ptable.lock);
80103d76:	83 ec 0c             	sub    $0xc,%esp
80103d79:	68 20 2d 11 80       	push   $0x80112d20
80103d7e:	e8 0d 0a 00 00       	call   80104790 <release>
	    continue;
80103d83:	83 c4 10             	add    $0x10,%esp
80103d86:	e9 0d ff ff ff       	jmp    80103c98 <scheduler+0x28>
...
80103d98:	53                   	push   %ebx
  pushcli();
80103d99:	e8 32 08 00 00       	call   801045d0 <pushcli>
  c = mycpu();
80103d9e:	e8 5d fb ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103da3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103da9:	e8 72 08 00 00       	call   80104620 <popcli>
 if(!holding(&ptable.lock))
80103dae:	83 ec 0c             	sub    $0xc,%esp
80103db1:	68 20 2d 11 80       	push   $0x80112d20
80103db6:	e8 c5 08 00 00       	call   80104680 <holding>
80103dbb:	83 c4 10             	add    $0x10,%esp
80103dbe:	85 c0                	test   %eax,%eax
80103dc0:	74 4f                	je     80103e11 <sched+0x81>
  if(mycpu()->ncli != 1)
80103dc2:	e8 39 fb ff ff       	call   80103900 <mycpu>
...
80103ddb:	75 41                	jne    80103e1e <sched+0x8e>
  intena = mycpu()->intena;
80103ddd:	e8 1e fb ff ff       	call   80103900 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103de2:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103de5:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103deb:	e8 10 fb ff ff       	call   80103900 <mycpu>
80103df0:	83 ec 08             	sub    $0x8,%esp
80103df3:	ff 70 04             	pushl  0x4(%eax)
80103df6:	53                   	push   %ebx
80103df7:	e8 07 0c 00 00       	call   80104a03 <swtch>
  mycpu()->intena = intena;
80103dfc:	e8 ff fa ff ff       	call   80103900 <mycpu>
}
...
80103e5a:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103e5d:	e8 6e 07 00 00       	call   801045d0 <pushcli>
  c = mycpu();
80103e62:	e8 99 fa ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103e67:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e6d:	e8 ae 07 00 00       	call   80104620 <popcli>
  if(curproc == initproc)
80103e72:	8d 73 28             	lea    0x28(%ebx),%esi
80103e75:	8d 7b 68             	lea    0x68(%ebx),%edi
80103e78:	39 1d b8 a5 10 80    	cmp    %ebx,0x8010a5b8
80103e7e:	0f 84 23 01 00 00    	je     80103fa7 <exit+0x157>
...
80103eaf:	ff 73 68             	pushl  0x68(%ebx)
...
80103eca:	e8 01 08 00 00       	call   801046d0 <acquire>
  wakeup1(curproc->parent);
80103ecf:	8b 73 14             	mov    0x14(%ebx),%esi
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ed5:	b9 54 2d 11 80       	mov    $0x80112d54,%ecx
80103eda:	eb 12                	jmp    80103eee <exit+0x9e>
80103edc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103ee0:	81 c1 88 00 00 00    	add    $0x88,%ecx
80103ee6:	81 f9 54 4f 11 80    	cmp    $0x80114f54,%ecx
80103eec:	74 31                	je     80103f1f <exit+0xcf>
    if(p->state == SLEEPING && p->chan == chan){
80103eee:	83 79 0c 02          	cmpl   $0x2,0xc(%ecx)
80103ef2:	75 ec                	jne    80103ee0 <exit+0x90>
80103ef4:	3b 71 20             	cmp    0x20(%ecx),%esi
80103ef7:	75 e7                	jne    80103ee0 <exit+0x90>
      p->state = RUNNABLE;
80103ef9:	c7 41 0c 03 00 00 00 	movl   $0x3,0xc(%ecx)
      p->priority = ptable.minPriority; //set wakeup process priority with minPriority (p3)
80103f00:	a1 54 4f 11 80       	mov    0x80114f54,%eax
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f05:	81 c1 88 00 00 00    	add    $0x88,%ecx
      p->priority = ptable.minPriority; //set wakeup process priority with minPriority (p3)
80103f0b:	8b 15 58 4f 11 80    	mov    0x80114f58,%edx
80103f11:	89 41 f4             	mov    %eax,-0xc(%ecx)
80103f14:	89 51 f8             	mov    %edx,-0x8(%ecx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f17:	81 f9 54 4f 11 80    	cmp    $0x80114f54,%ecx
80103f1d:	75 cf                	jne    80103eee <exit+0x9e>
      p->parent = initproc;
80103f1f:	8b 3d b8 a5 10 80    	mov    0x8010a5b8,%edi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f25:	be 54 2d 11 80       	mov    $0x80112d54,%esi
80103f2a:	eb 12                	jmp    80103f3e <exit+0xee>
80103f2c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103f30:	81 c6 88 00 00 00    	add    $0x88,%esi
80103f36:	81 fe 54 4f 11 80    	cmp    $0x80114f54,%esi
80103f3c:	74 50                	je     80103f8e <exit+0x13e>
    if(p->parent == curproc){
80103f3e:	39 5e 14             	cmp    %ebx,0x14(%esi)
80103f41:	75 ed                	jne    80103f30 <exit+0xe0>
      if(p->state == ZOMBIE)
80103f43:	83 7e 0c 05          	cmpl   $0x5,0xc(%esi)
      p->parent = initproc;
80103f47:	89 7e 14             	mov    %edi,0x14(%esi)
      if(p->state == ZOMBIE)
80103f4a:	75 e4                	jne    80103f30 <exit+0xe0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f4c:	b9 54 2d 11 80       	mov    $0x80112d54,%ecx
80103f51:	eb 13                	jmp    80103f66 <exit+0x116>
80103f53:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103f57:	90                   	nop
80103f58:	81 c1 88 00 00 00    	add    $0x88,%ecx
80103f5e:	81 f9 54 4f 11 80    	cmp    $0x80114f54,%ecx
80103f64:	74 ca                	je     80103f30 <exit+0xe0>
    if(p->state == SLEEPING && p->chan == chan){
80103f66:	83 79 0c 02          	cmpl   $0x2,0xc(%ecx)
80103f6a:	75 ec                	jne    80103f58 <exit+0x108>
80103f6c:	3b 79 20             	cmp    0x20(%ecx),%edi
80103f6f:	75 e7                	jne    80103f58 <exit+0x108>
      p->state = RUNNABLE;
80103f71:	c7 41 0c 03 00 00 00 	movl   $0x3,0xc(%ecx)
      p->priority = ptable.minPriority; //set wakeup process priority with minPriority (p3)
80103f78:	a1 54 4f 11 80       	mov    0x80114f54,%eax
80103f7d:	8b 15 58 4f 11 80    	mov    0x80114f58,%edx
80103f83:	89 41 7c             	mov    %eax,0x7c(%ecx)
80103f86:	89 91 80 00 00 00    	mov    %edx,0x80(%ecx)
80103f8c:	eb ca                	jmp    80103f58 <exit+0x108>
  curproc->state = ZOMBIE;
80103f8e:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  sched();
80103f95:	e8 f6 fd ff ff       	call   80103d90 <sched>
  panic("zombie exit");
80103f9a:	83 ec 0c             	sub    $0xc,%esp
80103f9d:	68 08 79 10 80       	push   $0x80107908
80103fa2:	e8 e9 c3 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103fa7:	83 ec 0c             	sub    $0xc,%esp
80103faa:	68 fb 78 10 80       	push   $0x801078fb
80103faf:	e8 dc c3 ff ff       	call   80100390 <panic>
80103fb4:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80103fd0:	e8 fb 06 00 00       	call   801046d0 <acquire>
  pushcli();
80103fd5:	e8 f6 05 00 00       	call   801045d0 <pushcli>
  c = mycpu();
80103fda:	e8 21 f9 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103fdf:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103fe5:	e8 36 06 00 00       	call   80104620 <popcli>
  myproc()->state = RUNNABLE;
80103fea:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103ff1:	e8 9a fd ff ff       	call   80103d90 <sched>
  release(&ptable.lock);
80103ff6:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103ffd:	e8 8e 07 00 00       	call   80104790 <release>
}
...
80104020:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80104023:	e8 a8 05 00 00       	call   801045d0 <pushcli>
  c = mycpu();
80104028:	e8 d3 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010402d:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104033:	e8 e8 05 00 00       	call   80104620 <popcli>
  if(p == 0)
...
8010408f:	5d                   	pop    %ebp
    acquire(lk);
80104090:	e9 3b 06 00 00       	jmp    801046d0 <acquire>
...
8010409b:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801040a2:	e8 e9 fc ff ff       	call   80103d90 <sched>
  p->chan = 0;
...
801040b9:	68 1a 79 10 80       	push   $0x8010791a
801040be:	e8 cd c2 ff ff       	call   80100390 <panic>
    panic("sleep");
801040c3:	83 ec 0c             	sub    $0xc,%esp
801040c6:	68 14 79 10 80       	push   $0x80107914
...
801040d9:	e8 f2 04 00 00       	call   801045d0 <pushcli>
  c = mycpu();
801040de:	e8 1d f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801040e3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801040e9:	e8 32 05 00 00       	call   80104620 <popcli>
  acquire(&ptable.lock);
801040ee:	83 ec 0c             	sub    $0xc,%esp
801040f1:	68 20 2d 11 80       	push   $0x80112d20
801040f6:	e8 d5 05 00 00       	call   801046d0 <acquire>
...
80104116:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
...
80104172:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104179:	e8 a2 2e 00 00       	call   80107020 <freevm>
        release(&ptable.lock);
...
8010419e:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801041a5:	e8 e6 05 00 00       	call   80104790 <release>
        return pid;
...
801041c3:	e8 c8 05 00 00       	call   80104790 <release>
      return -1;
...
801041e3:	e8 e8 04 00 00       	call   801046d0 <acquire>
801041e8:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801041eb:	b9 54 2d 11 80       	mov    $0x80112d54,%ecx
801041f0:	eb 14                	jmp    80104206 <wakeup+0x36>
801041f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801041f8:	81 c1 88 00 00 00    	add    $0x88,%ecx
801041fe:	81 f9 54 4f 11 80    	cmp    $0x80114f54,%ecx
80104204:	74 31                	je     80104237 <wakeup+0x67>
    if(p->state == SLEEPING && p->chan == chan){
80104206:	83 79 0c 02          	cmpl   $0x2,0xc(%ecx)
8010420a:	75 ec                	jne    801041f8 <wakeup+0x28>
8010420c:	3b 59 20             	cmp    0x20(%ecx),%ebx
8010420f:	75 e7                	jne    801041f8 <wakeup+0x28>
      p->state = RUNNABLE;
80104211:	c7 41 0c 03 00 00 00 	movl   $0x3,0xc(%ecx)
      p->priority = ptable.minPriority; //set wakeup process priority with minPriority (p3)
80104218:	a1 54 4f 11 80       	mov    0x80114f54,%eax
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010421d:	81 c1 88 00 00 00    	add    $0x88,%ecx
      p->priority = ptable.minPriority; //set wakeup process priority with minPriority (p3)
80104223:	8b 15 58 4f 11 80    	mov    0x80114f58,%edx
80104229:	89 41 f4             	mov    %eax,-0xc(%ecx)
8010422c:	89 51 f8             	mov    %edx,-0x8(%ecx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010422f:	81 f9 54 4f 11 80    	cmp    $0x80114f54,%ecx
80104235:	75 cf                	jne    80104206 <wakeup+0x36>
  wakeup1(chan);
  release(&ptable.lock);
80104237:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
8010423e:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104241:	c9                   	leave  
  release(&ptable.lock);
80104242:	e9 49 05 00 00       	jmp    80104790 <release>
...
80104263:	e8 68 04 00 00       	call   801046d0 <acquire>
...
8010427d:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
...
801042c0:	e8 cb 04 00 00       	call   80104790 <release>
}
...
80104303:	68 37 7d 10 80       	push   $0x80107d37
80104308:	e8 a3 c3 ff ff       	call   801006b0 <cprintf>
8010430d:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104310:	81 c3 88 00 00 00    	add    $0x88,%ebx
80104316:	81 fb c0 4f 11 80    	cmp    $0x80114fc0,%ebx
...
80104327:	74 e7                	je     80104310 <procdump+0x30>
      state = "???";
80104329:	ba 2b 79 10 80       	mov    $0x8010792b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010432e:	83 f8 05             	cmp    $0x5,%eax
80104331:	77 11                	ja     80104344 <procdump+0x64>
80104333:	8b 14 85 bc 79 10 80 	mov    -0x7fef8644(,%eax,4),%edx
      state = "???";
8010433a:	b8 2b 79 10 80       	mov    $0x8010792b,%eax
...
80104349:	68 2f 79 10 80       	push   $0x8010792f
...
80104370:	e8 fb 01 00 00       	call   80104570 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
80104391:	68 81 73 10 80       	push   $0x80107381
...
801043c9:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
801043cc:	e8 ff 01 00 00       	call   801045d0 <pushcli>
  c = mycpu();
801043d1:	e8 2a f5 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801043d6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801043dc:	e8 3f 02 00 00       	call   80104620 <popcli>
  struct proc *curproc = myproc();
  
  //since fork to set weight safely, acquire ptable and then set weight. release at last(p3)
  acquire(&ptable.lock);
801043e1:	83 ec 0c             	sub    $0xc,%esp
801043e4:	68 20 2d 11 80       	push   $0x80112d20
801043e9:	e8 e2 02 00 00       	call   801046d0 <acquire>
  curproc->weight = _weight;
801043ee:	89 b3 84 00 00 00    	mov    %esi,0x84(%ebx)
  release(&ptable.lock);
801043f4:	83 c4 10             	add    $0x10,%esp
801043f7:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
...
80104403:	5d                   	pop    %ebp
  release(&ptable.lock);
80104404:	e9 87 03 00 00       	jmp    80104790 <release>
...
8010441e:	68 d4 79 10 80       	push   $0x801079d4
80104423:	8d 43 04             	lea    0x4(%ebx),%eax
80104426:	50                   	push   %eax
80104427:	e8 24 01 00 00       	call   80104550 <initlock>
  lk->name = name;
...
80104435:	83 c4 10             	add    $0x10,%esp
  lk->pid = 0;
80104438:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  lk->name = name;
8010443f:	89 43 38             	mov    %eax,0x38(%ebx)
}
...
80104463:	e8 68 02 00 00       	call   801046d0 <acquire>
  while (lk->locked) {
80104468:	8b 13                	mov    (%ebx),%edx
8010446a:	83 c4 10             	add    $0x10,%esp
8010446d:	85 d2                	test   %edx,%edx
8010446f:	74 1a                	je     8010448b <acquiresleep+0x3b>
80104471:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    sleep(lk, &lk->lk);
80104478:	83 ec 08             	sub    $0x8,%esp
8010447b:	56                   	push   %esi
8010447c:	53                   	push   %ebx
8010447d:	e8 8e fb ff ff       	call   80104010 <sleep>
  while (lk->locked) {
80104482:	8b 03                	mov    (%ebx),%eax
80104484:	83 c4 10             	add    $0x10,%esp
80104487:	85 c0                	test   %eax,%eax
80104489:	75 ed                	jne    80104478 <acquiresleep+0x28>
  }
  lk->locked = 1;
8010448b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104491:	e8 fa f4 ff ff       	call   80103990 <myproc>
80104496:	8b 40 10             	mov    0x10(%eax),%eax
80104499:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
...
801044a4:	5d                   	pop    %ebp
  release(&lk->lk);
801044a5:	e9 e6 02 00 00       	jmp    80104790 <release>
...
801044c3:	e8 08 02 00 00       	call   801046d0 <acquire>
  lk->locked = 0;
801044c8:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
801044ce:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
801044d5:	89 1c 24             	mov    %ebx,(%esp)
801044d8:	e8 f3 fc ff ff       	call   801041d0 <wakeup>
  release(&lk->lk);
801044dd:	89 75 08             	mov    %esi,0x8(%ebp)
...
801044e8:	5d                   	pop    %ebp
  release(&lk->lk);
801044e9:	e9 a2 02 00 00       	jmp    80104790 <release>
...
801044f8:	31 ff                	xor    %edi,%edi
801044fa:	56                   	push   %esi
...
801044ff:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&lk->lk);
80104502:	8d 73 04             	lea    0x4(%ebx),%esi
80104505:	56                   	push   %esi
80104506:	e8 c5 01 00 00       	call   801046d0 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
8010450b:	8b 03                	mov    (%ebx),%eax
8010450d:	83 c4 10             	add    $0x10,%esp
80104510:	85 c0                	test   %eax,%eax
80104512:	75 1c                	jne    80104530 <holdingsleep+0x40>
  release(&lk->lk);
80104514:	83 ec 0c             	sub    $0xc,%esp
80104517:	56                   	push   %esi
80104518:	e8 73 02 00 00       	call   80104790 <release>
  return r;
}
8010451d:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104520:	89 f8                	mov    %edi,%eax
80104522:	5b                   	pop    %ebx
80104523:	5e                   	pop    %esi
80104524:	5f                   	pop    %edi
80104525:	5d                   	pop    %ebp
...
80104557:	8b 45 08             	mov    0x8(%ebp),%eax
  lk->name = name;
8010455a:	8b 55 0c             	mov    0xc(%ebp),%edx
  lk->locked = 0;
8010455d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->name = name;
80104563:	89 50 04             	mov    %edx,0x4(%eax)
  lk->cpu = 0;
80104566:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
8010456d:	5d                   	pop    %ebp
8010456e:	c3                   	ret    
8010456f:	90                   	nop
...
{
8010457d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ebp = (uint*)v - 2;
80104580:	83 e8 08             	sub    $0x8,%eax
  for(i = 0; i < 10; i++){
80104583:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104587:	90                   	nop
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104588:	8d 98 00 00 00 80    	lea    -0x80000000(%eax),%ebx
8010458e:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
80104594:	77 1a                	ja     801045b0 <getcallerpcs+0x40>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104596:	8b 58 04             	mov    0x4(%eax),%ebx
80104599:	89 1c 91             	mov    %ebx,(%ecx,%edx,4)
  for(i = 0; i < 10; i++){
8010459c:	83 c2 01             	add    $0x1,%edx
    ebp = (uint*)ebp[0]; // saved %ebp
8010459f:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
801045a1:	83 fa 0a             	cmp    $0xa,%edx
801045a4:	75 e2                	jne    80104588 <getcallerpcs+0x18>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
}
...
801045a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(; i < 10; i++)
801045b0:	8d 04 91             	lea    (%ecx,%edx,4),%eax
801045b3:	8d 51 28             	lea    0x28(%ecx),%edx
...
801045dd:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801045de:	e8 1d f3 ff ff       	call   80103900 <mycpu>
801045e3:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
801045e9:	85 c0                	test   %eax,%eax
801045eb:	74 13                	je     80104600 <pushcli+0x30>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
801045ed:	e8 0e f3 ff ff       	call   80103900 <mycpu>
801045f2:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
80104611:	eb da                	jmp    801045ed <pushcli+0x1d>
...
8010462b:	58                   	pop    %eax
  if(readeflags()&FL_IF)
8010462c:	f6 c4 02             	test   $0x2,%ah
8010462f:	75 31                	jne    80104662 <popcli+0x42>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
80104631:	e8 ca f2 ff ff       	call   80103900 <mycpu>
80104636:	83 a8 a4 00 00 00 01 	subl   $0x1,0xa4(%eax)
8010463d:	78 30                	js     8010466f <popcli+0x4f>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
8010463f:	e8 bc f2 ff ff       	call   80103900 <mycpu>
80104644:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
8010464a:	85 d2                	test   %edx,%edx
8010464c:	74 02                	je     80104650 <popcli+0x30>
    sti();
}
8010464e:	c9                   	leave  
8010464f:	c3                   	ret    
...
8010465d:	74 ef                	je     8010464e <popcli+0x2e>
  asm volatile("sti");
8010465f:	fb                   	sti    
}
80104660:	c9                   	leave  
...
80104665:	68 df 79 10 80       	push   $0x801079df
8010466a:	e8 21 bd ff ff       	call   80100390 <panic>
    panic("popcli");
8010466f:	83 ec 0c             	sub    $0xc,%esp
80104672:	68 f6 79 10 80       	push   $0x801079f6
...
8010468c:	31 db                	xor    %ebx,%ebx
  pushcli();
8010468e:	e8 3d ff ff ff       	call   801045d0 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80104693:	8b 06                	mov    (%esi),%eax
80104695:	85 c0                	test   %eax,%eax
80104697:	75 0f                	jne    801046a8 <holding+0x28>
  popcli();
80104699:	e8 82 ff ff ff       	call   80104620 <popcli>
}
...
801046a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  r = lock->locked && lock->cpu == mycpu();
801046a8:	8b 5e 08             	mov    0x8(%esi),%ebx
801046ab:	e8 50 f2 ff ff       	call   80103900 <mycpu>
801046b0:	39 c3                	cmp    %eax,%ebx
801046b2:	0f 94 c3             	sete   %bl
  popcli();
801046b5:	e8 66 ff ff ff       	call   80104620 <popcli>
  r = lock->locked && lock->cpu == mycpu();
801046ba:	0f b6 db             	movzbl %bl,%ebx
}
...
801046d9:	e8 f2 fe ff ff       	call   801045d0 <pushcli>
  if(holding(lk))
801046de:	8b 5d 08             	mov    0x8(%ebp),%ebx
801046e1:	83 ec 0c             	sub    $0xc,%esp
801046e4:	53                   	push   %ebx
801046e5:	e8 96 ff ff ff       	call   80104680 <holding>
801046ea:	83 c4 10             	add    $0x10,%esp
801046ed:	85 c0                	test   %eax,%eax
801046ef:	0f 85 7f 00 00 00    	jne    80104774 <acquire+0xa4>
801046f5:	89 c6                	mov    %eax,%esi
  asm volatile("lock; xchgl %0, %1" :
801046f7:	ba 01 00 00 00       	mov    $0x1,%edx
801046fc:	eb 05                	jmp    80104703 <acquire+0x33>
...
80104714:	e8 e7 f1 ff ff       	call   80103900 <mycpu>
80104719:	89 43 08             	mov    %eax,0x8(%ebx)
  ebp = (uint*)v - 2;
8010471c:	89 e8                	mov    %ebp,%eax
8010471e:	66 90                	xchg   %ax,%ax
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104720:	8d 90 00 00 00 80    	lea    -0x80000000(%eax),%edx
80104726:	81 fa fe ff ff 7f    	cmp    $0x7ffffffe,%edx
8010472c:	77 22                	ja     80104750 <acquire+0x80>
    pcs[i] = ebp[1];     // saved %eip
8010472e:	8b 50 04             	mov    0x4(%eax),%edx
80104731:	89 54 b3 0c          	mov    %edx,0xc(%ebx,%esi,4)
  for(i = 0; i < 10; i++){
80104735:	83 c6 01             	add    $0x1,%esi
    ebp = (uint*)ebp[0]; // saved %ebp
80104738:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
8010473a:	83 fe 0a             	cmp    $0xa,%esi
...
8010474d:	8d 76 00             	lea    0x0(%esi),%esi
  for(; i < 10; i++)
80104750:	8d 44 b3 0c          	lea    0xc(%ebx,%esi,4),%eax
...
80104769:	39 d8                	cmp    %ebx,%eax
8010476b:	75 f3                	jne    80104760 <acquire+0x90>
}
...
80104777:	68 fd 79 10 80       	push   $0x801079fd
...
8010479f:	e8 dc fe ff ff       	call   80104680 <holding>
801047a4:	83 c4 10             	add    $0x10,%esp
801047a7:	85 c0                	test   %eax,%eax
801047a9:	74 22                	je     801047cd <release+0x3d>
  lk->pcs[0] = 0;
801047ab:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
801047b2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
801047b9:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
801047be:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
801047c4:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801047c7:	c9                   	leave  
  popcli();
801047c8:	e9 53 fe ff ff       	jmp    80104620 <popcli>
    panic("release");
801047cd:	83 ec 0c             	sub    $0xc,%esp
801047d0:	68 05 7a 10 80       	push   $0x80107a05
801047d5:	e8 b6 bb ff ff       	call   80100390 <panic>
...
801047f4:	09 cf                	or     %ecx,%edi
801047f6:	83 e7 03             	and    $0x3,%edi
801047f9:	75 25                	jne    80104820 <memset+0x40>
    c &= 0xFF;
801047fb:	0f b6 f8             	movzbl %al,%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
801047fe:	c1 e0 18             	shl    $0x18,%eax
80104801:	89 fb                	mov    %edi,%ebx
80104803:	c1 e9 02             	shr    $0x2,%ecx
...
80104844:	74 2a                	je     80104870 <memcmp+0x40>
80104846:	01 c6                	add    %eax,%esi
80104848:	eb 10                	jmp    8010485a <memcmp+0x2a>
...
8010488f:	8b 75 0c             	mov    0xc(%ebp),%esi
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80104892:	39 d6                	cmp    %edx,%esi
80104894:	73 2a                	jae    801048c0 <memmove+0x40>
80104896:	8d 3c 0e             	lea    (%esi,%ecx,1),%edi
80104899:	39 fa                	cmp    %edi,%edx
8010489b:	73 23                	jae    801048c0 <memmove+0x40>
8010489d:	8d 41 ff             	lea    -0x1(%ecx),%eax
    s += n;
    d += n;
    while(n-- > 0)
801048a0:	85 c9                	test   %ecx,%ecx
801048a2:	74 13                	je     801048b7 <memmove+0x37>
801048a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      *--d = *--s;
801048a8:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
801048ac:	88 0c 02             	mov    %cl,(%edx,%eax,1)
    while(n-- > 0)
801048af:	83 e8 01             	sub    $0x1,%eax
801048b2:	83 f8 ff             	cmp    $0xffffffff,%eax
801048b5:	75 f1                	jne    801048a8 <memmove+0x28>
  } else
    while(n-- > 0)
      *d++ = *s++;
...
801048bd:	8d 76 00             	lea    0x0(%esi),%esi
    while(n-- > 0)
801048c0:	8d 04 0e             	lea    (%esi,%ecx,1),%eax
801048c3:	89 d7                	mov    %edx,%edi
801048c5:	85 c9                	test   %ecx,%ecx
801048c7:	74 ee                	je     801048b7 <memmove+0x37>
801048c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      *d++ = *s++;
801048d0:	a4                   	movsb  %ds:(%esi),%es:(%edi)
    while(n-- > 0)
801048d1:	39 f0                	cmp    %esi,%eax
801048d3:	75 fb                	jne    801048d0 <memmove+0x50>
}
801048d5:	5e                   	pop    %esi
...
801048fb:	8b 4d 08             	mov    0x8(%ebp),%ecx
801048fe:	53                   	push   %ebx
801048ff:	8b 45 0c             	mov    0xc(%ebp),%eax
  while(n > 0 && *p && *p == *q)
80104902:	85 f6                	test   %esi,%esi
80104904:	74 32                	je     80104938 <strncmp+0x48>
80104906:	01 c6                	add    %eax,%esi
80104908:	eb 14                	jmp    8010491e <strncmp+0x2e>
8010490a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104910:	38 da                	cmp    %bl,%dl
80104912:	75 14                	jne    80104928 <strncmp+0x38>
    n--, p++, q++;
80104914:	83 c0 01             	add    $0x1,%eax
80104917:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
8010491a:	39 f0                	cmp    %esi,%eax
8010491c:	74 1a                	je     80104938 <strncmp+0x48>
8010491e:	0f b6 11             	movzbl (%ecx),%edx
80104921:	0f b6 18             	movzbl (%eax),%ebx
...
8010494d:	8b 45 10             	mov    0x10(%ebp),%eax
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
80104950:	89 f2                	mov    %esi,%edx
80104952:	eb 1b                	jmp    8010496f <strncpy+0x2f>
80104954:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104958:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
8010495c:	8b 7d 0c             	mov    0xc(%ebp),%edi
8010495f:	83 c2 01             	add    $0x1,%edx
80104962:	0f b6 7f ff          	movzbl -0x1(%edi),%edi
80104966:	89 f9                	mov    %edi,%ecx
80104968:	88 4a ff             	mov    %cl,-0x1(%edx)
8010496b:	84 c9                	test   %cl,%cl
8010496d:	74 09                	je     80104978 <strncpy+0x38>
8010496f:	89 c3                	mov    %eax,%ebx
80104971:	83 e8 01             	sub    $0x1,%eax
80104974:	85 db                	test   %ebx,%ebx
80104976:	7f e0                	jg     80104958 <strncpy+0x18>
    ;
  while(n-- > 0)
80104978:	89 d1                	mov    %edx,%ecx
8010497a:	85 c0                	test   %eax,%eax
8010497c:	7e 15                	jle    80104993 <strncpy+0x53>
8010497e:	66 90                	xchg   %ax,%ax
    *s++ = 0;
80104980:	83 c1 01             	add    $0x1,%ecx
80104983:	c6 41 ff 00          	movb   $0x0,-0x1(%ecx)
  while(n-- > 0)
80104987:	89 c8                	mov    %ecx,%eax
80104989:	f7 d0                	not    %eax
8010498b:	01 d0                	add    %edx,%eax
8010498d:	01 d8                	add    %ebx,%eax
8010498f:	85 c0                	test   %eax,%eax
80104991:	7f ed                	jg     80104980 <strncpy+0x40>
  return os;
}
80104993:	5b                   	pop    %ebx
80104994:	89 f0                	mov    %esi,%eax
80104996:	5e                   	pop    %esi
80104997:	5f                   	pop    %edi
80104998:	5d                   	pop    %ebp
80104999:	c3                   	ret    
...
801049a8:	8b 55 10             	mov    0x10(%ebp),%edx
801049ab:	8b 75 08             	mov    0x8(%ebp),%esi
...
801049b4:	7e 21                	jle    801049d7 <safestrcpy+0x37>
801049b6:	8d 5c 10 ff          	lea    -0x1(%eax,%edx,1),%ebx
801049ba:	89 f2                	mov    %esi,%edx
801049bc:	eb 12                	jmp    801049d0 <safestrcpy+0x30>
...
801049e9:	8b 55 08             	mov    0x8(%ebp),%edx
  for(n = 0; s[n]; n++)
801049ec:	80 3a 00             	cmpb   $0x0,(%edx)
801049ef:	74 10                	je     80104a01 <strlen+0x21>
801049f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801049f8:	83 c0 01             	add    $0x1,%eax
801049fb:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
801049ff:	75 f7                	jne    801049f8 <strlen+0x18>
    ;
  return n;
}
80104a01:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
80104a03:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80104a07:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80104a0d:	56                   	push   %esi
  pushl %edi
80104a0e:	57                   	push   %edi

  # Switch stacks
  movl %esp, (%eax)
80104a0f:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80104a11:	89 d4                	mov    %edx,%esp
...
80104a35:	39 d8                	cmp    %ebx,%eax
80104a37:	76 17                	jbe    80104a50 <fetchint+0x30>
80104a39:	8d 53 04             	lea    0x4(%ebx),%edx
80104a3c:	39 d0                	cmp    %edx,%eax
80104a3e:	72 10                	jb     80104a50 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
80104a40:	8b 45 0c             	mov    0xc(%ebp),%eax
80104a43:	8b 13                	mov    (%ebx),%edx
80104a45:	89 10                	mov    %edx,(%eax)
  return 0;
80104a47:	31 c0                	xor    %eax,%eax
}
80104a49:	83 c4 04             	add    $0x4,%esp
80104a4c:	5b                   	pop    %ebx
80104a4d:	5d                   	pop    %ebp
80104a4e:	c3                   	ret    
80104a4f:	90                   	nop
...
80104a55:	eb f2                	jmp    80104a49 <fetchint+0x29>
...
80104a6e:	e8 1d ef ff ff       	call   80103990 <myproc>
  ...
  if(addr >= curproc->sz)
80104a73:	39 18                	cmp    %ebx,(%eax)
80104a75:	76 31                	jbe    80104aa8 <fetchstr+0x48>
    return -1;
  *pp = (char*)addr;
...
80104a80:	73 26                	jae    80104aa8 <fetchstr+0x48>
80104a82:	89 d8                	mov    %ebx,%eax
80104a84:	eb 11                	jmp    80104a97 <fetchstr+0x37>
...
80104a95:	76 11                	jbe    80104aa8 <fetchstr+0x48>
    if(*s == 0)
80104a97:	80 38 00             	cmpb   $0x0,(%eax)
80104a9a:	75 f4                	jne    80104a90 <fetchstr+0x30>
      return s - *pp;
  }
  return -1;
}
...
80104ad4:	8b 40 44             	mov    0x44(%eax),%eax
80104ad7:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104ada:	e8 b1 ee ff ff       	call   80103990 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104adf:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104ae2:	8b 00                	mov    (%eax),%eax
80104ae4:	39 c6                	cmp    %eax,%esi
80104ae6:	73 18                	jae    80104b00 <argint+0x40>
80104ae8:	8d 53 08             	lea    0x8(%ebx),%edx
80104aeb:	39 d0                	cmp    %edx,%eax
80104aed:	72 11                	jb     80104b00 <argint+0x40>
  *ip = *(int*)(addr);
80104aef:	8b 45 0c             	mov    0xc(%ebp),%eax
80104af2:	8b 53 04             	mov    0x4(%ebx),%edx
...
80104b00:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104b05:	eb f2                	jmp    80104af9 <argint+0x39>
...
80104b1c:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104b1f:	e8 6c ee ff ff       	call   80103990 <myproc>
 
  if(argint(n, &i) < 0)
80104b24:	83 ec 08             	sub    $0x8,%esp
  struct proc *curproc = myproc();
80104b27:	89 c6                	mov    %eax,%esi
  if(argint(n, &i) < 0)
80104b29:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104b2c:	50                   	push   %eax
80104b2d:	ff 75 08             	pushl  0x8(%ebp)
80104b30:	e8 8b ff ff ff       	call   80104ac0 <argint>
    return -1;
...
80104b56:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104b59:	5b                   	pop    %ebx
80104b5a:	5e                   	pop    %esi
80104b5b:	5d                   	pop    %ebp
80104b5c:	c3                   	ret    
...
80104b65:	eb ef                	jmp    80104b56 <argptr+0x46>
...
80104bb0 <syscall>:
[SYS_printTerminated] sys_printTerminated, //print terminated process pid (p3)
};
...
80104bb8:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104bbb:	e8 d0 ed ff ff       	call   80103990 <myproc>
80104bc0:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
80104bc2:	8b 40 18             	mov    0x18(%eax),%eax
80104bc5:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104bc8:	8d 50 ff             	lea    -0x1(%eax),%edx
80104bcb:	83 fa 17             	cmp    $0x17,%edx
80104bce:	77 20                	ja     80104bf0 <syscall+0x40>
80104bd0:	8b 14 85 40 7a 10 80 	mov    -0x7fef85c0(,%eax,4),%edx
80104bd7:	85 d2                	test   %edx,%edx
80104bd9:	74 15                	je     80104bf0 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
80104bdb:	ff d2                	call   *%edx
80104bdd:	89 c2                	mov    %eax,%edx
80104bdf:	8b 43 18             	mov    0x18(%ebx),%eax
80104be2:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
80104bf5:	ff 73 10             	pushl  0x10(%ebx)
80104bf8:	68 0d 7a 10 80       	push   $0x80107a0d
...
80104c37:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104c3a:	e8 11 d4 ff ff       	call   80102050 <nameiparent>
...
80104c5c:	e8 4f d0 ff ff       	call   80101cb0 <dirlookup>
...
80104c6e:	e8 8d cd ff ff       	call   80101a00 <iunlockput>
    ilock(ip);
80104c73:	89 34 24             	mov    %esi,(%esp)
80104c76:	e8 e5 ca ff ff       	call   80101760 <ilock>
...
80104ca4:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104ca6:	e8 55 cd ff ff       	call   80101a00 <iunlockput>
    return 0;
...
80104cca:	e8 11 c9 ff ff       	call   801015e0 <ialloc>
...
80104d01:	e8 9a c9 ff ff       	call   801016a0 <iupdate>
...
80104d13:	ff 76 04             	pushl  0x4(%esi)
80104d16:	57                   	push   %edi
80104d17:	53                   	push   %ebx
80104d18:	e8 53 d2 ff ff       	call   80101f70 <dirlink>
...
80104d28:	e8 d3 cc ff ff       	call   80101a00 <iunlockput>
  return ip;
...
80104d49:	e8 52 c9 ff ff       	call   801016a0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104d4e:	83 c4 0c             	add    $0xc,%esp
80104d51:	ff 76 04             	pushl  0x4(%esi)
80104d54:	68 c0 7a 10 80       	push   $0x80107ac0
80104d59:	56                   	push   %esi
80104d5a:	e8 11 d2 ff ff       	call   80101f70 <dirlink>
...
80104d6c:	68 bf 7a 10 80       	push   $0x80107abf
80104d71:	56                   	push   %esi
80104d72:	e8 f9 d1 ff ff       	call   80101f70 <dirlink>
...
80104d81:	68 b3 7a 10 80       	push   $0x80107ab3
...
80104d9f:	68 c2 7a 10 80       	push   $0x80107ac2
80104da4:	e8 e7 b5 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104da9:	83 ec 0c             	sub    $0xc,%esp
80104dac:	68 a4 7a 10 80       	push   $0x80107aa4
80104db1:	e8 da b5 ff ff       	call   80100390 <panic>
...
80104dc4:	89 d6                	mov    %edx,%esi
80104dc6:	53                   	push   %ebx
80104dc7:	89 c3                	mov    %eax,%ebx
  if(argint(n, &fd) < 0)
...
80104de4:	e8 a7 eb ff ff       	call   80103990 <myproc>
...
80104e1a:	53                   	push   %ebx
  if(argfd(0, 0, &f) < 0)
80104e1b:	8d 55 f4             	lea    -0xc(%ebp),%edx
{
80104e1e:	83 ec 10             	sub    $0x10,%esp
  if(argfd(0, 0, &f) < 0)
80104e21:	e8 9a ff ff ff       	call   80104dc0 <argfd.constprop.0>
80104e26:	85 c0                	test   %eax,%eax
80104e28:	78 1e                	js     80104e48 <sys_dup+0x38>
  if((fd=fdalloc(f)) < 0)
80104e2a:	8b 75 f4             	mov    -0xc(%ebp),%esi
  for(fd = 0; fd < NOFILE; fd++){
80104e2d:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104e2f:	e8 5c eb ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80104e34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
80104e38:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
80104e3c:	85 d2                	test   %edx,%edx
80104e3e:	74 20                	je     80104e60 <sys_dup+0x50>
  for(fd = 0; fd < NOFILE; fd++){
80104e40:	83 c3 01             	add    $0x1,%ebx
80104e43:	83 fb 10             	cmp    $0x10,%ebx
...
80104e5d:	8d 76 00             	lea    0x0(%esi),%esi
      curproc->ofile[fd] = f;
80104e60:	89 74 98 28          	mov    %esi,0x28(%eax,%ebx,4)
  filedup(f);
80104e64:	83 ec 0c             	sub    $0xc,%esp
80104e67:	ff 75 f4             	pushl  -0xc(%ebp)
80104e6a:	e8 01 c0 ff ff       	call   80100e70 <filedup>
  return fd;
...
80104e89:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80104e8c:	8d 55 ec             	lea    -0x14(%ebp),%edx
80104e8f:	e8 2c ff ff ff       	call   80104dc0 <argfd.constprop.0>
80104e94:	85 c0                	test   %eax,%eax
80104e96:	78 48                	js     80104ee0 <sys_read+0x60>
80104e98:	83 ec 08             	sub    $0x8,%esp
80104e9b:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104e9e:	50                   	push   %eax
80104e9f:	6a 02                	push   $0x2
80104ea1:	e8 1a fc ff ff       	call   80104ac0 <argint>
80104ea6:	83 c4 10             	add    $0x10,%esp
80104ea9:	85 c0                	test   %eax,%eax
80104eab:	78 33                	js     80104ee0 <sys_read+0x60>
80104ead:	83 ec 04             	sub    $0x4,%esp
80104eb0:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104eb3:	ff 75 f0             	pushl  -0x10(%ebp)
80104eb6:	50                   	push   %eax
80104eb7:	6a 01                	push   $0x1
80104eb9:	e8 52 fc ff ff       	call   80104b10 <argptr>
80104ebe:	83 c4 10             	add    $0x10,%esp
80104ec1:	85 c0                	test   %eax,%eax
80104ec3:	78 1b                	js     80104ee0 <sys_read+0x60>
  return fileread(f, p, n);
80104ec5:	83 ec 04             	sub    $0x4,%esp
80104ec8:	ff 75 f0             	pushl  -0x10(%ebp)
80104ecb:	ff 75 f4             	pushl  -0xc(%ebp)
80104ece:	ff 75 ec             	pushl  -0x14(%ebp)
80104ed1:	e8 1a c1 ff ff       	call   80100ff0 <fileread>
...
80104f29:	e8 e2 fb ff ff       	call   80104b10 <argptr>
80104f2e:	83 c4 10             	add    $0x10,%esp
80104f31:	85 c0                	test   %eax,%eax
80104f33:	78 1b                	js     80104f50 <sys_write+0x60>
...
80104f41:	e8 4a c1 ff ff       	call   80101090 <filewrite>
...
80104f67:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, &fd, &f) < 0)
80104f6a:	8d 55 f4             	lea    -0xc(%ebp),%edx
80104f6d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104f70:	e8 4b fe ff ff       	call   80104dc0 <argfd.constprop.0>
80104f75:	85 c0                	test   %eax,%eax
80104f77:	78 27                	js     80104fa0 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104f79:	e8 12 ea ff ff       	call   80103990 <myproc>
80104f7e:	8b 55 f0             	mov    -0x10(%ebp),%edx
  fileclose(f);
80104f81:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80104f84:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
80104f8b:	00 
  fileclose(f);
80104f8c:	ff 75 f4             	pushl  -0xc(%ebp)
80104f8f:	e8 2c bf ff ff       	call   80100ec0 <fileclose>
  return 0;
...
80104fb9:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
80104fbc:	8d 55 f0             	lea    -0x10(%ebp),%edx
80104fbf:	e8 fc fd ff ff       	call   80104dc0 <argfd.constprop.0>
80104fc4:	85 c0                	test   %eax,%eax
80104fc6:	78 30                	js     80104ff8 <sys_fstat+0x48>
80104fc8:	83 ec 04             	sub    $0x4,%esp
80104fcb:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104fce:	6a 14                	push   $0x14
80104fd0:	50                   	push   %eax
80104fd1:	6a 01                	push   $0x1
80104fd3:	e8 38 fb ff ff       	call   80104b10 <argptr>
80104fd8:	83 c4 10             	add    $0x10,%esp
80104fdb:	85 c0                	test   %eax,%eax
80104fdd:	78 19                	js     80104ff8 <sys_fstat+0x48>
  return filestat(f, st);
80104fdf:	83 ec 08             	sub    $0x8,%esp
80104fe2:	ff 75 f4             	pushl  -0xc(%ebp)
80104fe5:	ff 75 f0             	pushl  -0x10(%ebp)
80104fe8:	e8 b3 bf ff ff       	call   80100fa0 <filestat>
...
80105009:	8d 45 d4             	lea    -0x2c(%ebp),%eax
{
8010500c:	53                   	push   %ebx
8010500d:	83 ec 34             	sub    $0x34,%esp
  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80105010:	50                   	push   %eax
80105011:	6a 00                	push   $0x0
80105013:	e8 58 fb ff ff       	call   80104b70 <argstr>
80105018:	83 c4 10             	add    $0x10,%esp
8010501b:	85 c0                	test   %eax,%eax
8010501d:	0f 88 ff 00 00 00    	js     80105122 <sys_link+0x122>
80105023:	83 ec 08             	sub    $0x8,%esp
80105026:	8d 45 d0             	lea    -0x30(%ebp),%eax
80105029:	50                   	push   %eax
8010502a:	6a 01                	push   $0x1
8010502c:	e8 3f fb ff ff       	call   80104b70 <argstr>
80105031:	83 c4 10             	add    $0x10,%esp
80105034:	85 c0                	test   %eax,%eax
80105036:	0f 88 e6 00 00 00    	js     80105122 <sys_link+0x122>
  begin_op();
8010503c:	e8 ef dc ff ff       	call   80102d30 <begin_op>
  if((ip = namei(old)) == 0){
80105041:	83 ec 0c             	sub    $0xc,%esp
80105044:	ff 75 d4             	pushl  -0x2c(%ebp)
80105047:	e8 e4 cf ff ff       	call   80102030 <namei>
8010504c:	83 c4 10             	add    $0x10,%esp
8010504f:	89 c3                	mov    %eax,%ebx
80105051:	85 c0                	test   %eax,%eax
80105053:	0f 84 e8 00 00 00    	je     80105141 <sys_link+0x141>
  ilock(ip);
...
80105065:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
8010506a:	0f 84 b9 00 00 00    	je     80105129 <sys_link+0x129>
  iupdate(ip);
80105070:	83 ec 0c             	sub    $0xc,%esp
  ip->nlink++;
80105073:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
  if((dp = nameiparent(new, name)) == 0)
80105078:	8d 7d da             	lea    -0x26(%ebp),%edi
  iupdate(ip);
8010507b:	53                   	push   %ebx
8010507c:	e8 1f c6 ff ff       	call   801016a0 <iupdate>
  iunlock(ip);
80105081:	89 1c 24             	mov    %ebx,(%esp)
80105084:	e8 b7 c7 ff ff       	call   80101840 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80105089:	58                   	pop    %eax
8010508a:	5a                   	pop    %edx
8010508b:	57                   	push   %edi
8010508c:	ff 75 d0             	pushl  -0x30(%ebp)
8010508f:	e8 bc cf ff ff       	call   80102050 <nameiparent>
80105094:	83 c4 10             	add    $0x10,%esp
80105097:	89 c6                	mov    %eax,%esi
80105099:	85 c0                	test   %eax,%eax
8010509b:	74 5f                	je     801050fc <sys_link+0xfc>
  ilock(dp);
8010509d:	83 ec 0c             	sub    $0xc,%esp
801050a0:	50                   	push   %eax
801050a1:	e8 ba c6 ff ff       	call   80101760 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
801050a6:	8b 03                	mov    (%ebx),%eax
801050a8:	83 c4 10             	add    $0x10,%esp
801050ab:	39 06                	cmp    %eax,(%esi)
801050ad:	75 41                	jne    801050f0 <sys_link+0xf0>
801050af:	83 ec 04             	sub    $0x4,%esp
801050b2:	ff 73 04             	pushl  0x4(%ebx)
801050b5:	57                   	push   %edi
801050b6:	56                   	push   %esi
801050b7:	e8 b4 ce ff ff       	call   80101f70 <dirlink>
801050bc:	83 c4 10             	add    $0x10,%esp
801050bf:	85 c0                	test   %eax,%eax
801050c1:	78 2d                	js     801050f0 <sys_link+0xf0>
  iunlockput(dp);
801050c3:	83 ec 0c             	sub    $0xc,%esp
801050c6:	56                   	push   %esi
801050c7:	e8 34 c9 ff ff       	call   80101a00 <iunlockput>
  iput(ip);
801050cc:	89 1c 24             	mov    %ebx,(%esp)
801050cf:	e8 bc c7 ff ff       	call   80101890 <iput>
  end_op();
801050d4:	e8 c7 dc ff ff       	call   80102da0 <end_op>
  return 0;
...
801050f4:	e8 07 c9 ff ff       	call   80101a00 <iunlockput>
    goto bad;
...
80105100:	e8 5b c6 ff ff       	call   80101760 <ilock>
  ip->nlink--;
80105105:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
8010510a:	89 1c 24             	mov    %ebx,(%esp)
8010510d:	e8 8e c5 ff ff       	call   801016a0 <iupdate>
  iunlockput(ip);
80105112:	89 1c 24             	mov    %ebx,(%esp)
80105115:	e8 e6 c8 ff ff       	call   80101a00 <iunlockput>
  end_op();
8010511a:	e8 81 dc ff ff       	call   80102da0 <end_op>
  return -1;
8010511f:	83 c4 10             	add    $0x10,%esp
80105122:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105127:	eb b5                	jmp    801050de <sys_link+0xde>
    iunlockput(ip);
80105129:	83 ec 0c             	sub    $0xc,%esp
8010512c:	53                   	push   %ebx
8010512d:	e8 ce c8 ff ff       	call   80101a00 <iunlockput>
    end_op();
80105132:	e8 69 dc ff ff       	call   80102da0 <end_op>
    return -1;
80105137:	83 c4 10             	add    $0x10,%esp
8010513a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010513f:	eb 9d                	jmp    801050de <sys_link+0xde>
    end_op();
80105141:	e8 5a dc ff ff       	call   80102da0 <end_op>
    return -1;
80105146:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010514b:	eb 91                	jmp    801050de <sys_link+0xde>
...
80105158:	56                   	push   %esi
  if(argstr(0, &path) < 0)
80105159:	8d 45 c0             	lea    -0x40(%ebp),%eax
{
8010515c:	53                   	push   %ebx
8010515d:	83 ec 54             	sub    $0x54,%esp
  if(argstr(0, &path) < 0)
80105160:	50                   	push   %eax
80105161:	6a 00                	push   $0x0
80105163:	e8 08 fa ff ff       	call   80104b70 <argstr>
80105168:	83 c4 10             	add    $0x10,%esp
8010516b:	85 c0                	test   %eax,%eax
8010516d:	0f 88 7d 01 00 00    	js     801052f0 <sys_unlink+0x1a0>
  begin_op();
80105173:	e8 b8 db ff ff       	call   80102d30 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105178:	8d 5d ca             	lea    -0x36(%ebp),%ebx
8010517b:	83 ec 08             	sub    $0x8,%esp
8010517e:	53                   	push   %ebx
8010517f:	ff 75 c0             	pushl  -0x40(%ebp)
80105182:	e8 c9 ce ff ff       	call   80102050 <nameiparent>
80105187:	83 c4 10             	add    $0x10,%esp
8010518a:	89 c6                	mov    %eax,%esi
8010518c:	85 c0                	test   %eax,%eax
8010518e:	0f 84 66 01 00 00    	je     801052fa <sys_unlink+0x1aa>
  ilock(dp);
80105194:	83 ec 0c             	sub    $0xc,%esp
80105197:	50                   	push   %eax
80105198:	e8 c3 c5 ff ff       	call   80101760 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
8010519d:	58                   	pop    %eax
8010519e:	5a                   	pop    %edx
8010519f:	68 c0 7a 10 80       	push   $0x80107ac0
801051a4:	53                   	push   %ebx
801051a5:	e8 e6 ca ff ff       	call   80101c90 <namecmp>
801051aa:	83 c4 10             	add    $0x10,%esp
801051ad:	85 c0                	test   %eax,%eax
801051af:	0f 84 03 01 00 00    	je     801052b8 <sys_unlink+0x168>
801051b5:	83 ec 08             	sub    $0x8,%esp
801051b8:	68 bf 7a 10 80       	push   $0x80107abf
801051bd:	53                   	push   %ebx
801051be:	e8 cd ca ff ff       	call   80101c90 <namecmp>
801051c3:	83 c4 10             	add    $0x10,%esp
801051c6:	85 c0                	test   %eax,%eax
801051c8:	0f 84 ea 00 00 00    	je     801052b8 <sys_unlink+0x168>
...
801051d7:	e8 d4 ca ff ff       	call   80101cb0 <dirlookup>
801051dc:	83 c4 10             	add    $0x10,%esp
801051df:	89 c3                	mov    %eax,%ebx
801051e1:	85 c0                	test   %eax,%eax
801051e3:	0f 84 cf 00 00 00    	je     801052b8 <sys_unlink+0x168>
  ilock(ip);
...
801051fa:	0f 8e 23 01 00 00    	jle    80105323 <sys_unlink+0x1d3>
...
80105212:	e8 c9 f5 ff ff       	call   801047e0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105217:	6a 10                	push   $0x10
80105219:	ff 75 c4             	pushl  -0x3c(%ebp)
8010521c:	57                   	push   %edi
8010521d:	56                   	push   %esi
8010521e:	e8 3d c9 ff ff       	call   80101b60 <writei>
80105223:	83 c4 20             	add    $0x20,%esp
80105226:	83 f8 10             	cmp    $0x10,%eax
80105229:	0f 85 e7 00 00 00    	jne    80105316 <sys_unlink+0x1c6>
  if(ip->type == T_DIR){
8010522f:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105234:	0f 84 96 00 00 00    	je     801052d0 <sys_unlink+0x180>
  iunlockput(dp);
8010523a:	83 ec 0c             	sub    $0xc,%esp
8010523d:	56                   	push   %esi
8010523e:	e8 bd c7 ff ff       	call   80101a00 <iunlockput>
  ip->nlink--;
80105243:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105248:	89 1c 24             	mov    %ebx,(%esp)
8010524b:	e8 50 c4 ff ff       	call   801016a0 <iupdate>
  iunlockput(ip);
80105250:	89 1c 24             	mov    %ebx,(%esp)
80105253:	e8 a8 c7 ff ff       	call   80101a00 <iunlockput>
  end_op();
80105258:	e8 43 db ff ff       	call   80102da0 <end_op>
  return 0;
...
80105276:	ba 20 00 00 00       	mov    $0x20,%edx
8010527b:	eb 0b                	jmp    80105288 <sys_unlink+0x138>
8010527d:	8d 76 00             	lea    0x0(%esi),%esi
80105280:	83 c2 10             	add    $0x10,%edx
80105283:	39 53 58             	cmp    %edx,0x58(%ebx)
80105286:	76 82                	jbe    8010520a <sys_unlink+0xba>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105288:	6a 10                	push   $0x10
8010528a:	52                   	push   %edx
8010528b:	57                   	push   %edi
8010528c:	53                   	push   %ebx
8010528d:	89 55 b4             	mov    %edx,-0x4c(%ebp)
80105290:	e8 cb c7 ff ff       	call   80101a60 <readi>
80105295:	83 c4 10             	add    $0x10,%esp
80105298:	8b 55 b4             	mov    -0x4c(%ebp),%edx
8010529b:	83 f8 10             	cmp    $0x10,%eax
8010529e:	75 69                	jne    80105309 <sys_unlink+0x1b9>
    if(de.inum != 0)
801052a0:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
801052a5:	74 d9                	je     80105280 <sys_unlink+0x130>
    iunlockput(ip);
801052a7:	83 ec 0c             	sub    $0xc,%esp
801052aa:	53                   	push   %ebx
801052ab:	e8 50 c7 ff ff       	call   80101a00 <iunlockput>
    goto bad;
...
801052bc:	e8 3f c7 ff ff       	call   80101a00 <iunlockput>
  end_op();
801052c1:	e8 da da ff ff       	call   80102da0 <end_op>
  return -1;
801052c6:	83 c4 10             	add    $0x10,%esp
801052c9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801052ce:	eb 92                	jmp    80105262 <sys_unlink+0x112>
    iupdate(dp);
801052d0:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink--;
801052d3:	66 83 6e 56 01       	subw   $0x1,0x56(%esi)
    iupdate(dp);
801052d8:	56                   	push   %esi
801052d9:	e8 c2 c3 ff ff       	call   801016a0 <iupdate>
801052de:	83 c4 10             	add    $0x10,%esp
801052e1:	e9 54 ff ff ff       	jmp    8010523a <sys_unlink+0xea>
...
801052f5:	e9 68 ff ff ff       	jmp    80105262 <sys_unlink+0x112>
    end_op();
801052fa:	e8 a1 da ff ff       	call   80102da0 <end_op>
    return -1;
801052ff:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105304:	e9 59 ff ff ff       	jmp    80105262 <sys_unlink+0x112>
      panic("isdirempty: readi");
80105309:	83 ec 0c             	sub    $0xc,%esp
8010530c:	68 e4 7a 10 80       	push   $0x80107ae4
80105311:	e8 7a b0 ff ff       	call   80100390 <panic>
    panic("unlink: writei");
80105316:	83 ec 0c             	sub    $0xc,%esp
80105319:	68 f6 7a 10 80       	push   $0x80107af6
8010531e:	e8 6d b0 ff ff       	call   80100390 <panic>
    panic("unlink: nlink < 1");
80105323:	83 ec 0c             	sub    $0xc,%esp
80105326:	68 d2 7a 10 80       	push   $0x80107ad2
8010532b:	e8 60 b0 ff ff       	call   80100390 <panic>
...
80105339:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
8010533c:	53                   	push   %ebx
8010533d:	83 ec 24             	sub    $0x24,%esp
  if(argstr(0, &path) < 0 || argint(1, &omode) < 0)
80105340:	50                   	push   %eax
80105341:	6a 00                	push   $0x0
80105343:	e8 28 f8 ff ff       	call   80104b70 <argstr>
80105348:	83 c4 10             	add    $0x10,%esp
8010534b:	85 c0                	test   %eax,%eax
8010534d:	0f 88 8a 00 00 00    	js     801053dd <sys_open+0xad>
80105353:	83 ec 08             	sub    $0x8,%esp
80105356:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105359:	50                   	push   %eax
8010535a:	6a 01                	push   $0x1
8010535c:	e8 5f f7 ff ff       	call   80104ac0 <argint>
80105361:	83 c4 10             	add    $0x10,%esp
80105364:	85 c0                	test   %eax,%eax
80105366:	78 75                	js     801053dd <sys_open+0xad>
    return -1;

  begin_op();
80105368:	e8 c3 d9 ff ff       	call   80102d30 <begin_op>

  if(omode & O_CREATE){
8010536d:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80105371:	75 75                	jne    801053e8 <sys_open+0xb8>
    if(ip == 0){
      end_op();
      return -1;
    }
...
80105376:	ff 75 e0             	pushl  -0x20(%ebp)
80105379:	e8 b2 cc ff ff       	call   80102030 <namei>
8010537e:	83 c4 10             	add    $0x10,%esp
80105381:	89 c6                	mov    %eax,%esi
80105383:	85 c0                	test   %eax,%eax
80105385:	74 7e                	je     80105405 <sys_open+0xd5>
      end_op();
      return -1;
    }
    ilock(ip);
...
8010538b:	e8 d0 c3 ff ff       	call   80101760 <ilock>
...
801053c4:	e8 f7 ba ff ff       	call   80100ec0 <fileclose>
801053c9:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
801053cc:	83 ec 0c             	sub    $0xc,%esp
801053cf:	56                   	push   %esi
801053d0:	e8 2b c6 ff ff       	call   80101a00 <iunlockput>
    end_op();
...
801053f7:	e8 24 f8 ff ff       	call   80104c20 <create>
    if(ip == 0){
...
80105420:	e8 1b c4 ff ff       	call   80101840 <iunlock>
  end_op();
...
801054b3:	e8 48 c5 ff ff       	call   80101a00 <iunlockput>
  end_op();
...
801054f2:	8d 45 ec             	lea    -0x14(%ebp),%eax
801054f5:	50                   	push   %eax
801054f6:	6a 00                	push   $0x0
801054f8:	e8 73 f6 ff ff       	call   80104b70 <argstr>
801054fd:	83 c4 10             	add    $0x10,%esp
80105500:	85 c0                	test   %eax,%eax
80105502:	78 64                	js     80105568 <sys_mknod+0x88>
     argint(1, &major) < 0 ||
80105504:	83 ec 08             	sub    $0x8,%esp
80105507:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010550a:	50                   	push   %eax
8010550b:	6a 01                	push   $0x1
8010550d:	e8 ae f5 ff ff       	call   80104ac0 <argint>
  if((argstr(0, &path)) < 0 ||
80105512:	83 c4 10             	add    $0x10,%esp
80105515:	85 c0                	test   %eax,%eax
80105517:	78 4f                	js     80105568 <sys_mknod+0x88>
     argint(2, &minor) < 0 ||
80105519:	83 ec 08             	sub    $0x8,%esp
8010551c:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010551f:	50                   	push   %eax
80105520:	6a 02                	push   $0x2
80105522:	e8 99 f5 ff ff       	call   80104ac0 <argint>
     argint(1, &major) < 0 ||
80105527:	83 c4 10             	add    $0x10,%esp
8010552a:	85 c0                	test   %eax,%eax
8010552c:	78 3a                	js     80105568 <sys_mknod+0x88>
     (ip = create(path, T_DEV, major, minor)) == 0){
8010552e:	0f bf 45 f4          	movswl -0xc(%ebp),%eax
80105532:	83 ec 0c             	sub    $0xc,%esp
80105535:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
80105539:	ba 03 00 00 00       	mov    $0x3,%edx
8010553e:	50                   	push   %eax
8010553f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80105542:	e8 d9 f6 ff ff       	call   80104c20 <create>
     argint(2, &minor) < 0 ||
80105547:	83 c4 10             	add    $0x10,%esp
8010554a:	85 c0                	test   %eax,%eax
8010554c:	74 1a                	je     80105568 <sys_mknod+0x88>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
80105552:	e8 a9 c4 ff ff       	call   80101a00 <iunlockput>
  end_op();
80105557:	e8 44 d8 ff ff       	call   80102da0 <end_op>
  return 0;
...
80105572:	c9                   	leave  
80105573:	c3                   	ret    
80105574:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
801055c5:	e8 96 c1 ff ff       	call   80101760 <ilock>
  if(ip->type != T_DIR){
801055ca:	83 c4 10             	add    $0x10,%esp
801055cd:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801055d2:	75 2c                	jne    80105600 <sys_chdir+0x80>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
801055d8:	e8 63 c2 ff ff       	call   80101840 <iunlock>
  iput(curproc->cwd);
801055dd:	58                   	pop    %eax
801055de:	ff 76 68             	pushl  0x68(%esi)
801055e1:	e8 aa c2 ff ff       	call   80101890 <iput>
  end_op();
801055e6:	e8 b5 d7 ff ff       	call   80102da0 <end_op>
  curproc->cwd = ip;
801055eb:	89 5e 68             	mov    %ebx,0x68(%esi)
  return 0;
...
80105604:	e8 f7 c3 ff ff       	call   80101a00 <iunlockput>
    end_op();
80105609:	e8 92 d7 ff ff       	call   80102da0 <end_op>
    return -1;
...
8010561f:	90                   	nop
    end_op();
80105620:	e8 7b d7 ff ff       	call   80102da0 <end_op>
    return -1;
...
80105639:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
{
8010563f:	53                   	push   %ebx
80105640:	81 ec a4 00 00 00    	sub    $0xa4,%esp
  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
80105646:	50                   	push   %eax
80105647:	6a 00                	push   $0x0
80105649:	e8 22 f5 ff ff       	call   80104b70 <argstr>
8010564e:	83 c4 10             	add    $0x10,%esp
80105651:	85 c0                	test   %eax,%eax
80105653:	0f 88 8b 00 00 00    	js     801056e4 <sys_exec+0xb4>
80105659:	83 ec 08             	sub    $0x8,%esp
8010565c:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
80105662:	50                   	push   %eax
80105663:	6a 01                	push   $0x1
80105665:	e8 56 f4 ff ff       	call   80104ac0 <argint>
8010566a:	83 c4 10             	add    $0x10,%esp
8010566d:	85 c0                	test   %eax,%eax
8010566f:	78 73                	js     801056e4 <sys_exec+0xb4>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80105671:	83 ec 04             	sub    $0x4,%esp
80105674:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
  for(i=0;; i++){
8010567a:	31 db                	xor    %ebx,%ebx
  memset(argv, 0, sizeof(argv));
8010567c:	68 80 00 00 00       	push   $0x80
80105681:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
80105687:	6a 00                	push   $0x0
80105689:	50                   	push   %eax
8010568a:	e8 51 f1 ff ff       	call   801047e0 <memset>
8010568f:	83 c4 10             	add    $0x10,%esp
80105692:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(i >= NELEM(argv))
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80105698:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
8010569e:	8d 34 9d 00 00 00 00 	lea    0x0(,%ebx,4),%esi
801056a5:	83 ec 08             	sub    $0x8,%esp
801056a8:	57                   	push   %edi
801056a9:	01 f0                	add    %esi,%eax
801056ab:	50                   	push   %eax
801056ac:	e8 6f f3 ff ff       	call   80104a20 <fetchint>
801056b1:	83 c4 10             	add    $0x10,%esp
801056b4:	85 c0                	test   %eax,%eax
801056b6:	78 2c                	js     801056e4 <sys_exec+0xb4>
      return -1;
    if(uarg == 0){
801056b8:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
801056be:	85 c0                	test   %eax,%eax
801056c0:	74 36                	je     801056f8 <sys_exec+0xc8>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
801056c2:	8d 8d 68 ff ff ff    	lea    -0x98(%ebp),%ecx
801056c8:	83 ec 08             	sub    $0x8,%esp
801056cb:	8d 14 31             	lea    (%ecx,%esi,1),%edx
801056ce:	52                   	push   %edx
801056cf:	50                   	push   %eax
801056d0:	e8 8b f3 ff ff       	call   80104a60 <fetchstr>
801056d5:	83 c4 10             	add    $0x10,%esp
801056d8:	85 c0                	test   %eax,%eax
801056da:	78 08                	js     801056e4 <sys_exec+0xb4>
  for(i=0;; i++){
801056dc:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
801056df:	83 fb 20             	cmp    $0x20,%ebx
801056e2:	75 b4                	jne    80105698 <sys_exec+0x68>
      return -1;
  }
  return exec(path, argv);
}
801056e4:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return -1;
...
801056fb:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
      argv[i] = 0;
80105701:	c7 84 9d 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%ebx,4)
80105708:	00 00 00 00 
  return exec(path, argv);
8010570c:	50                   	push   %eax
8010570d:	ff b5 5c ff ff ff    	pushl  -0xa4(%ebp)
80105713:	e8 68 b3 ff ff       	call   80100a80 <exec>
80105718:	83 c4 10             	add    $0x10,%esp
}
8010571b:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010571e:	5b                   	pop    %ebx
8010571f:	5e                   	pop    %esi
80105720:	5f                   	pop    %edi
80105721:	5d                   	pop    %ebp
...
80105739:	8d 45 dc             	lea    -0x24(%ebp),%eax
{
8010573c:	53                   	push   %ebx
8010573d:	83 ec 20             	sub    $0x20,%esp
  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
80105740:	6a 08                	push   $0x8
80105742:	50                   	push   %eax
80105743:	6a 00                	push   $0x0
80105745:	e8 c6 f3 ff ff       	call   80104b10 <argptr>
8010574a:	83 c4 10             	add    $0x10,%esp
8010574d:	85 c0                	test   %eax,%eax
8010574f:	78 4e                	js     8010579f <sys_pipe+0x6f>
    return -1;
...
8010575c:	e8 8f dc ff ff       	call   801033f0 <pipealloc>
80105761:	83 c4 10             	add    $0x10,%esp
80105764:	85 c0                	test   %eax,%eax
80105766:	78 37                	js     8010579f <sys_pipe+0x6f>
    return -1;
  fd0 = -1;
...
801057ce:	74 20                	je     801057f0 <sys_pipe+0xc0>
  for(fd = 0; fd < NOFILE; fd++){
801057d0:	83 c2 01             	add    $0x1,%edx
801057d3:	83 fa 10             	cmp    $0x10,%edx
801057d6:	75 f0                	jne    801057c8 <sys_pipe+0x98>
      myproc()->ofile[fd0] = 0;
801057d8:	e8 b3 e1 ff ff       	call   80103990 <myproc>
801057dd:	c7 44 b0 08 00 00 00 	movl   $0x0,0x8(%eax,%esi,4)
801057e4:	00 
801057e5:	eb a1                	jmp    80105788 <sys_pipe+0x58>
...
80105810:	f3 0f 1e fb          	endbr32 
  return fork();
80105814:	e9 37 e3 ff ff       	jmp    80103b50 <fork>
...
80105827:	83 ec 08             	sub    $0x8,%esp
  exit();
8010582a:	e8 21 e6 ff ff       	call   80103e50 <exit>
...
80105840:	f3 0f 1e fb          	endbr32 
  return wait();
80105844:	e9 87 e8 ff ff       	jmp    801040d0 <wait>
...
80105857:	83 ec 20             	sub    $0x20,%esp
  int pid;

  if(argint(0, &pid) < 0)
8010585a:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010585d:	50                   	push   %eax
8010585e:	6a 00                	push   $0x0
80105860:	e8 5b f2 ff ff       	call   80104ac0 <argint>
80105865:	83 c4 10             	add    $0x10,%esp
80105868:	85 c0                	test   %eax,%eax
8010586a:	78 14                	js     80105880 <sys_kill+0x30>
    return -1;
  return kill(pid);
8010586c:	83 ec 0c             	sub    $0xc,%esp
8010586f:	ff 75 f4             	pushl  -0xc(%ebp)
80105872:	e8 d9 e9 ff ff       	call   80104250 <kill>
...
80105897:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
8010589a:	e8 f1 e0 ff ff       	call   80103990 <myproc>
...
801058c1:	e8 fa f1 ff ff       	call   80104ac0 <argint>
801058c6:	83 c4 10             	add    $0x10,%esp
801058c9:	85 c0                	test   %eax,%eax
801058cb:	78 23                	js     801058f0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801058cd:	e8 be e0 ff ff       	call   80103990 <myproc>
  if(growproc(n) < 0)
801058d2:	83 ec 0c             	sub    $0xc,%esp
  addr = myproc()->sz;
801058d5:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
801058d7:	ff 75 f4             	pushl  -0xc(%ebp)
801058da:	e8 f1 e1 ff ff       	call   80103ad0 <growproc>
801058df:	83 c4 10             	add    $0x10,%esp
801058e2:	85 c0                	test   %eax,%eax
801058e4:	78 0a                	js     801058f0 <sys_sbrk+0x40>
    return -1;
  return addr;
}
801058e6:	89 d8                	mov    %ebx,%eax
...
801058f5:	eb ef                	jmp    801058e6 <sys_sbrk+0x36>
...
{
8010590b:	83 ec 1c             	sub    $0x1c,%esp
  if(argint(0, &n) < 0)
8010590e:	50                   	push   %eax
8010590f:	6a 00                	push   $0x0
80105911:	e8 aa f1 ff ff       	call   80104ac0 <argint>
80105916:	83 c4 10             	add    $0x10,%esp
80105919:	85 c0                	test   %eax,%eax
8010591b:	0f 88 86 00 00 00    	js     801059a7 <sys_sleep+0xa7>
    return -1;
  acquire(&tickslock);
80105921:	83 ec 0c             	sub    $0xc,%esp
80105924:	68 60 4f 11 80       	push   $0x80114f60
80105929:	e8 a2 ed ff ff       	call   801046d0 <acquire>
  ticks0 = ticks;
...
8010593a:	85 d2                	test   %edx,%edx
8010593c:	75 23                	jne    80105961 <sys_sleep+0x61>
8010593e:	eb 50                	jmp    80105990 <sys_sleep+0x90>
    if(myproc()->killed){
      release(&tickslock);
      return -1;
    }
...
80105943:	68 60 4f 11 80       	push   $0x80114f60
80105948:	68 a0 57 11 80       	push   $0x801157a0
8010594d:	e8 be e6 ff ff       	call   80104010 <sleep>
  while(ticks - ticks0 < n){
80105952:	a1 a0 57 11 80       	mov    0x801157a0,%eax
...
8010595f:	73 2f                	jae    80105990 <sys_sleep+0x90>
    if(myproc()->killed){
80105961:	e8 2a e0 ff ff       	call   80103990 <myproc>
...
801059b8:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801059bb:	68 60 4f 11 80       	push   $0x80114f60
801059c0:	e8 0b ed ff ff       	call   801046d0 <acquire>
  xticks = ticks;
801059c5:	8b 1d a0 57 11 80    	mov    0x801157a0,%ebx
  release(&tickslock);
801059cb:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
801059d2:	e8 b9 ed ff ff       	call   80104790 <release>
  return xticks;
}
801059d7:	89 d8                	mov    %ebx,%eax
801059d9:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801059dc:	c9                   	leave  
801059dd:	c3                   	ret    
801059de:	66 90                	xchg   %ax,%ax

801059e0 <sys_weightset>:
...
801059f0:	e8 cb f0 ff ff       	call   80104ac0 <argint>
801059f5:	83 c4 10             	add    $0x10,%esp
801059f8:	85 c0                	test   %eax,%eax
801059fa:	78 33                	js     80105a2f <sys_weightset+0x4f>
    return -1;
  if(newWeight==0){
801059fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059ff:	85 c0                	test   %eax,%eax
80105a01:	74 15                	je     80105a18 <sys_weightset+0x38>
...
80105a07:	e8 b4 e9 ff ff       	call   801043c0 <weightset>
...
80105a1b:	68 05 7b 10 80       	push   $0x80107b05
80105a20:	e8 8b ac ff ff       	call   801006b0 <cprintf>
    return -1;
...
80105a48:	83 ec 14             	sub    $0x14,%esp
  int time;
  struct proc* curproc = myproc();
80105a4b:	e8 40 df ff ff       	call   80103990 <myproc>

  if(argint(0, &time) < 0)
80105a50:	83 ec 08             	sub    $0x8,%esp
  struct proc* curproc = myproc();
80105a53:	89 c3                	mov    %eax,%ebx
  if(argint(0, &time) < 0)
80105a55:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105a58:	50                   	push   %eax
80105a59:	6a 00                	push   $0x0
80105a5b:	e8 60 f0 ff ff       	call   80104ac0 <argint>
80105a60:	83 c4 10             	add    $0x10,%esp
80105a63:	85 c0                	test   %eax,%eax
80105a65:	78 29                	js     80105a90 <sys_printProcInfo+0x50>
    return -1;
...
80105a6a:	ff b3 84 00 00 00    	pushl  0x84(%ebx)
80105a70:	ff 73 10             	pushl  0x10(%ebx)
80105a73:	68 34 7b 10 80       	push   $0x80107b34
80105a78:	e8 33 ac ff ff       	call   801006b0 <cprintf>
...
80105a95:	eb eb                	jmp    80105a82 <sys_printProcInfo+0x42>
80105a97:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105a9e:	66 90                	xchg   %ax,%ax

80105aa0 <sys_printTerminated>:
...
80105ac4:	06                   	push   %es
  pushl %fs
80105ac5:	0f a0                	push   %fs
  pushl %gs
80105ac7:	0f a8                	push   %gs
  pushal
80105ac9:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105aca:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105ace:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105ad0:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105ad2:	54                   	push   %esp
  call trap
80105ad3:	e8 c8 00 00 00       	call   80105ba0 <trap>
  addl $4, %esp
80105ad8:	83 c4 04             	add    $0x4,%esp
...
80105adb:	61                   	popa   
  popl %gs
80105adc:	0f a9                	pop    %gs
  popl %fs
80105ade:	0f a1                	pop    %fs
  popl %es
80105ae0:	07                   	pop    %es
  popl %ds
80105ae1:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105ae2:	83 c4 08             	add    $0x8,%esp
  iret
80105ae5:	cf                   	iret   
...
80105b00:	8b 14 85 0c a0 10 80 	mov    -0x7fef5ff4(,%eax,4),%edx
80105b07:	c7 04 c5 a2 4f 11 80 	movl   $0x8e000008,-0x7feeb05e(,%eax,8)
80105b0e:	08 00 00 8e 
80105b12:	66 89 14 c5 a0 4f 11 	mov    %dx,-0x7feeb060(,%eax,8)
80105b19:	80 
80105b1a:	c1 ea 10             	shr    $0x10,%edx
80105b1d:	66 89 14 c5 a6 4f 11 	mov    %dx,-0x7feeb05a(,%eax,8)
80105b24:	80 
  for(i = 0; i < 256; i++)
...
80105b2f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105b32:	a1 0c a1 10 80       	mov    0x8010a10c,%eax
80105b37:	c7 05 a2 51 11 80 08 	movl   $0xef000008,0x801151a2
80105b3e:	00 00 ef 
  initlock(&tickslock, "time");
80105b41:	68 58 7b 10 80       	push   $0x80107b58
80105b46:	68 60 4f 11 80       	push   $0x80114f60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105b4b:	66 a3 a0 51 11 80    	mov    %ax,0x801151a0
80105b51:	c1 e8 10             	shr    $0x10,%eax
80105b54:	66 a3 a6 51 11 80    	mov    %ax,0x801151a6
  initlock(&tickslock, "time");
80105b5a:	e8 f1 e9 ff ff       	call   80104550 <initlock>
}
...
80105b74:	55                   	push   %ebp
  pd[0] = size-1;
80105b75:	b8 ff 07 00 00       	mov    $0x7ff,%eax
80105b7a:	89 e5                	mov    %esp,%ebp
80105b7c:	83 ec 10             	sub    $0x10,%esp
80105b7f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105b83:	b8 a0 4f 11 80       	mov    $0x80114fa0,%eax
80105b88:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80105b8c:	c1 e8 10             	shr    $0x10,%eax
80105b8f:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80105b93:	8d 45 fa             	lea    -0x6(%ebp),%eax
80105b96:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80105b99:	c9                   	leave  
80105b9a:	c3                   	ret    
...
80105baa:	83 ec 1c             	sub    $0x1c,%esp
80105bad:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
80105bb0:	8b 43 30             	mov    0x30(%ebx),%eax
80105bb3:	83 f8 40             	cmp    $0x40,%eax
80105bb6:	0f 84 bc 01 00 00    	je     80105d78 <trap+0x1d8>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80105bbc:	83 e8 20             	sub    $0x20,%eax
80105bbf:	83 f8 1f             	cmp    $0x1f,%eax
80105bc2:	77 08                	ja     80105bcc <trap+0x2c>
80105bc4:	3e ff 24 85 00 7c 10 	notrack jmp *-0x7fef8400(,%eax,4)
80105bcb:	80 
    lapiceoi();
    break;
...
80105bcc:	e8 bf dd ff ff       	call   80103990 <myproc>
80105bd1:	8b 7b 38             	mov    0x38(%ebx),%edi
80105bd4:	85 c0                	test   %eax,%eax
80105bd6:	0f 84 eb 01 00 00    	je     80105dc7 <trap+0x227>
80105bdc:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105be0:	0f 84 e1 01 00 00    	je     80105dc7 <trap+0x227>
...
80105be6:	0f 20 d1             	mov    %cr2,%ecx
80105be9:	89 4d d8             	mov    %ecx,-0x28(%ebp)
...
80105bec:	e8 7f dd ff ff       	call   80103970 <cpuid>
80105bf1:	8b 73 30             	mov    0x30(%ebx),%esi
80105bf4:	89 45 dc             	mov    %eax,-0x24(%ebp)
80105bf7:	8b 43 34             	mov    0x34(%ebx),%eax
80105bfa:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105bfd:	e8 8e dd ff ff       	call   80103990 <myproc>
80105c02:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105c05:	e8 86 dd ff ff       	call   80103990 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105c0a:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105c0d:	8b 55 dc             	mov    -0x24(%ebp),%edx
80105c10:	51                   	push   %ecx
80105c11:	57                   	push   %edi
80105c12:	52                   	push   %edx
80105c13:	ff 75 e4             	pushl  -0x1c(%ebp)
80105c16:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105c17:	8b 75 e0             	mov    -0x20(%ebp),%esi
80105c1a:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105c1d:	56                   	push   %esi
80105c1e:	ff 70 10             	pushl  0x10(%eax)
80105c21:	68 bc 7b 10 80       	push   $0x80107bbc
80105c26:	e8 85 aa ff ff       	call   801006b0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105c2b:	83 c4 20             	add    $0x20,%esp
80105c2e:	e8 5d dd ff ff       	call   80103990 <myproc>
80105c33:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
...
80105c3a:	e8 51 dd ff ff       	call   80103990 <myproc>
80105c3f:	85 c0                	test   %eax,%eax
80105c41:	74 1d                	je     80105c60 <trap+0xc0>
80105c43:	e8 48 dd ff ff       	call   80103990 <myproc>
80105c48:	8b 50 24             	mov    0x24(%eax),%edx
80105c4b:	85 d2                	test   %edx,%edx
80105c4d:	74 11                	je     80105c60 <trap+0xc0>
80105c4f:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105c53:	83 e0 03             	and    $0x3,%eax
80105c56:	66 83 f8 03          	cmp    $0x3,%ax
80105c5a:	0f 84 50 01 00 00    	je     80105db0 <trap+0x210>
    exit();
...
80105c67:	74 0f                	je     80105c78 <trap+0xd8>
80105c69:	e8 22 dd ff ff       	call   80103990 <myproc>
80105c6e:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105c72:	0f 84 e8 00 00 00    	je     80105d60 <trap+0x1c0>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c78:	e8 13 dd ff ff       	call   80103990 <myproc>
80105c7d:	85 c0                	test   %eax,%eax
80105c7f:	74 1d                	je     80105c9e <trap+0xfe>
80105c81:	e8 0a dd ff ff       	call   80103990 <myproc>
80105c86:	8b 40 24             	mov    0x24(%eax),%eax
80105c89:	85 c0                	test   %eax,%eax
80105c8b:	74 11                	je     80105c9e <trap+0xfe>
80105c8d:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105c91:	83 e0 03             	and    $0x3,%eax
80105c94:	66 83 f8 03          	cmp    $0x3,%ax
80105c98:	0f 84 03 01 00 00    	je     80105da1 <trap+0x201>
    exit();
}
...
80105ca5:	c3                   	ret    
    ideintr();
80105ca6:	e8 35 c5 ff ff       	call   801021e0 <ideintr>
    lapiceoi();
80105cab:	e8 10 cc ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cb0:	e8 db dc ff ff       	call   80103990 <myproc>
80105cb5:	85 c0                	test   %eax,%eax
80105cb7:	75 8a                	jne    80105c43 <trap+0xa3>
80105cb9:	eb a5                	jmp    80105c60 <trap+0xc0>
    if(cpuid() == 0){
80105cbb:	e8 b0 dc ff ff       	call   80103970 <cpuid>
80105cc0:	85 c0                	test   %eax,%eax
80105cc2:	75 e7                	jne    80105cab <trap+0x10b>
      acquire(&tickslock);
80105cc4:	83 ec 0c             	sub    $0xc,%esp
80105cc7:	68 60 4f 11 80       	push   $0x80114f60
80105ccc:	e8 ff e9 ff ff       	call   801046d0 <acquire>
      wakeup(&ticks);
80105cd1:	c7 04 24 a0 57 11 80 	movl   $0x801157a0,(%esp)
      ticks++;
80105cd8:	83 05 a0 57 11 80 01 	addl   $0x1,0x801157a0
      wakeup(&ticks);
80105cdf:	e8 ec e4 ff ff       	call   801041d0 <wakeup>
      release(&tickslock);
80105ce4:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
80105ceb:	e8 a0 ea ff ff       	call   80104790 <release>
80105cf0:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105cf3:	eb b6                	jmp    80105cab <trap+0x10b>
    kbdintr();
80105cf5:	e8 86 ca ff ff       	call   80102780 <kbdintr>
    lapiceoi();
80105cfa:	e8 c1 cb ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cff:	e8 8c dc ff ff       	call   80103990 <myproc>
80105d04:	85 c0                	test   %eax,%eax
80105d06:	0f 85 37 ff ff ff    	jne    80105c43 <trap+0xa3>
80105d0c:	e9 4f ff ff ff       	jmp    80105c60 <trap+0xc0>
    uartintr();
80105d11:	e8 4a 02 00 00       	call   80105f60 <uartintr>
    lapiceoi();
80105d16:	e8 a5 cb ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d1b:	e8 70 dc ff ff       	call   80103990 <myproc>
80105d20:	85 c0                	test   %eax,%eax
80105d22:	0f 85 1b ff ff ff    	jne    80105c43 <trap+0xa3>
80105d28:	e9 33 ff ff ff       	jmp    80105c60 <trap+0xc0>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105d2d:	8b 7b 38             	mov    0x38(%ebx),%edi
80105d30:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105d34:	e8 37 dc ff ff       	call   80103970 <cpuid>
80105d39:	57                   	push   %edi
80105d3a:	56                   	push   %esi
80105d3b:	50                   	push   %eax
80105d3c:	68 64 7b 10 80       	push   $0x80107b64
80105d41:	e8 6a a9 ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105d46:	e8 75 cb ff ff       	call   801028c0 <lapiceoi>
    break;
80105d4b:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d4e:	e8 3d dc ff ff       	call   80103990 <myproc>
80105d53:	85 c0                	test   %eax,%eax
80105d55:	0f 85 e8 fe ff ff    	jne    80105c43 <trap+0xa3>
80105d5b:	e9 00 ff ff ff       	jmp    80105c60 <trap+0xc0>
  if(myproc() && myproc()->state == RUNNING &&
80105d60:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105d64:	0f 85 0e ff ff ff    	jne    80105c78 <trap+0xd8>
    yield();
80105d6a:	e8 51 e2 ff ff       	call   80103fc0 <yield>
80105d6f:	e9 04 ff ff ff       	jmp    80105c78 <trap+0xd8>
80105d74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105d78:	e8 13 dc ff ff       	call   80103990 <myproc>
80105d7d:	8b 70 24             	mov    0x24(%eax),%esi
80105d80:	85 f6                	test   %esi,%esi
80105d82:	75 3c                	jne    80105dc0 <trap+0x220>
    myproc()->tf = tf;
80105d84:	e8 07 dc ff ff       	call   80103990 <myproc>
80105d89:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105d8c:	e8 1f ee ff ff       	call   80104bb0 <syscall>
    if(myproc()->killed)
80105d91:	e8 fa db ff ff       	call   80103990 <myproc>
80105d96:	8b 48 24             	mov    0x24(%eax),%ecx
80105d99:	85 c9                	test   %ecx,%ecx
80105d9b:	0f 84 fd fe ff ff    	je     80105c9e <trap+0xfe>
}
...
80105da7:	5d                   	pop    %ebp
      exit();
80105da8:	e9 a3 e0 ff ff       	jmp    80103e50 <exit>
80105dad:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80105db0:	e8 9b e0 ff ff       	call   80103e50 <exit>
80105db5:	e9 a6 fe ff ff       	jmp    80105c60 <trap+0xc0>
80105dba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105dc0:	e8 8b e0 ff ff       	call   80103e50 <exit>
80105dc5:	eb bd                	jmp    80105d84 <trap+0x1e4>
80105dc7:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105dca:	e8 a1 db ff ff       	call   80103970 <cpuid>
80105dcf:	83 ec 0c             	sub    $0xc,%esp
80105dd2:	56                   	push   %esi
80105dd3:	57                   	push   %edi
80105dd4:	50                   	push   %eax
80105dd5:	ff 73 30             	pushl  0x30(%ebx)
80105dd8:	68 88 7b 10 80       	push   $0x80107b88
80105ddd:	e8 ce a8 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105de2:	83 c4 14             	add    $0x14,%esp
80105de5:	68 5d 7b 10 80       	push   $0x80107b5d
80105dea:	e8 a1 a5 ff ff       	call   80100390 <panic>
80105def:	90                   	nop
...
80105df0:	f3 0f 1e fb          	endbr32 
  if(!uart)
80105df4:	a1 bc a5 10 80       	mov    0x8010a5bc,%eax
80105df9:	85 c0                	test   %eax,%eax
80105dfb:	74 1b                	je     80105e18 <uartgetc+0x28>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105dfd:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105e02:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80105e03:	a8 01                	test   $0x1,%al
80105e05:	74 11                	je     80105e18 <uartgetc+0x28>
80105e07:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105e0c:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
80105e0d:	0f b6 c0             	movzbl %al,%eax
80105e10:	c3                   	ret    
...
80105e20 <uartputc.part.0>:
uartputc(int c)
80105e20:	55                   	push   %ebp
80105e21:	89 e5                	mov    %esp,%ebp
80105e23:	57                   	push   %edi
80105e24:	89 c7                	mov    %eax,%edi
80105e26:	56                   	push   %esi
80105e27:	be fd 03 00 00       	mov    $0x3fd,%esi
80105e2c:	53                   	push   %ebx
80105e2d:	bb 80 00 00 00       	mov    $0x80,%ebx
80105e32:	83 ec 0c             	sub    $0xc,%esp
80105e35:	eb 1b                	jmp    80105e52 <uartputc.part.0+0x32>
...
80105e45:	e8 96 ca ff ff       	call   801028e0 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105e4a:	83 c4 10             	add    $0x10,%esp
80105e4d:	83 eb 01             	sub    $0x1,%ebx
80105e50:	74 07                	je     80105e59 <uartputc.part.0+0x39>
80105e52:	89 f2                	mov    %esi,%edx
80105e54:	ec                   	in     (%dx),%al
80105e55:	a8 20                	test   $0x20,%al
80105e57:	74 e7                	je     80105e40 <uartputc.part.0+0x20>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105e59:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105e5e:	89 f8                	mov    %edi,%eax
...
80105e75:	31 c9                	xor    %ecx,%ecx
80105e77:	89 c8                	mov    %ecx,%eax
80105e79:	89 e5                	mov    %esp,%ebp
80105e7b:	57                   	push   %edi
80105e7c:	56                   	push   %esi
80105e7d:	53                   	push   %ebx
80105e7e:	bb fa 03 00 00       	mov    $0x3fa,%ebx
80105e83:	89 da                	mov    %ebx,%edx
80105e85:	83 ec 0c             	sub    $0xc,%esp
80105e88:	ee                   	out    %al,(%dx)
80105e89:	bf fb 03 00 00       	mov    $0x3fb,%edi
80105e8e:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
80105e93:	89 fa                	mov    %edi,%edx
80105e95:	ee                   	out    %al,(%dx)
80105e96:	b8 0c 00 00 00       	mov    $0xc,%eax
80105e9b:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105ea0:	ee                   	out    %al,(%dx)
80105ea1:	be f9 03 00 00       	mov    $0x3f9,%esi
80105ea6:	89 c8                	mov    %ecx,%eax
80105ea8:	89 f2                	mov    %esi,%edx
80105eaa:	ee                   	out    %al,(%dx)
80105eab:	b8 03 00 00 00       	mov    $0x3,%eax
80105eb0:	89 fa                	mov    %edi,%edx
80105eb2:	ee                   	out    %al,(%dx)
80105eb3:	ba fc 03 00 00       	mov    $0x3fc,%edx
80105eb8:	89 c8                	mov    %ecx,%eax
80105eba:	ee                   	out    %al,(%dx)
80105ebb:	b8 01 00 00 00       	mov    $0x1,%eax
80105ec0:	89 f2                	mov    %esi,%edx
80105ec2:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105ec3:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105ec8:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
80105ec9:	3c ff                	cmp    $0xff,%al
80105ecb:	74 52                	je     80105f1f <uartinit+0xaf>
  uart = 1;
80105ecd:	c7 05 bc a5 10 80 01 	movl   $0x1,0x8010a5bc
80105ed4:	00 00 00 
80105ed7:	89 da                	mov    %ebx,%edx
80105ed9:	ec                   	in     (%dx),%al
80105eda:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105edf:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80105ee0:	83 ec 08             	sub    $0x8,%esp
80105ee3:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105ee8:	bb 80 7c 10 80       	mov    $0x80107c80,%ebx
  ioapicenable(IRQ_COM1, 0);
80105eed:	6a 00                	push   $0x0
80105eef:	6a 04                	push   $0x4
80105ef1:	e8 3a c5 ff ff       	call   80102430 <ioapicenable>
80105ef6:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80105ef9:	b8 78 00 00 00       	mov    $0x78,%eax
80105efe:	eb 04                	jmp    80105f04 <uartinit+0x94>
80105f00:	0f b6 73 01          	movzbl 0x1(%ebx),%esi
  if(!uart)
80105f04:	8b 15 bc a5 10 80    	mov    0x8010a5bc,%edx
80105f0a:	85 d2                	test   %edx,%edx
80105f0c:	74 08                	je     80105f16 <uartinit+0xa6>
    uartputc(*p);
80105f0e:	0f be c0             	movsbl %al,%eax
80105f11:	e8 0a ff ff ff       	call   80105e20 <uartputc.part.0>
  for(p="xv6...\n"; *p; p++)
80105f16:	89 f0                	mov    %esi,%eax
80105f18:	83 c3 01             	add    $0x1,%ebx
80105f1b:	84 c0                	test   %al,%al
80105f1d:	75 e1                	jne    80105f00 <uartinit+0x90>
}
...
80105f34:	55                   	push   %ebp
  if(!uart)
80105f35:	8b 15 bc a5 10 80    	mov    0x8010a5bc,%edx
{
80105f3b:	89 e5                	mov    %esp,%ebp
80105f3d:	8b 45 08             	mov    0x8(%ebp),%eax
  if(!uart)
80105f40:	85 d2                	test   %edx,%edx
80105f42:	74 0c                	je     80105f50 <uartputc+0x20>
}
80105f44:	5d                   	pop    %ebp
80105f45:	e9 d6 fe ff ff       	jmp    80105e20 <uartputc.part.0>
...
80105f67:	83 ec 14             	sub    $0x14,%esp
  consoleintr(uartgetc);
80105f6a:	68 f0 5d 10 80       	push   $0x80105df0
80105f6f:	e8 ec a8 ff ff       	call   80100860 <consoleintr>
}
...
80105f7b:	6a 00                	push   $0x0
  jmp alltraps
80105f7d:	e9 41 fb ff ff       	jmp    80105ac3 <alltraps>
...
80105f84:	6a 01                	push   $0x1
  jmp alltraps
80105f86:	e9 38 fb ff ff       	jmp    80105ac3 <alltraps>
...
80105f8b:	6a 00                	push   $0x0
  pushl $2
80105f8d:	6a 02                	push   $0x2
  jmp alltraps
80105f8f:	e9 2f fb ff ff       	jmp    80105ac3 <alltraps>
...
80105f94:	6a 00                	push   $0x0
  pushl $3
80105f96:	6a 03                	push   $0x3
  jmp alltraps
80105f98:	e9 26 fb ff ff       	jmp    80105ac3 <alltraps>
...
80105f9f:	6a 04                	push   $0x4
  jmp alltraps
80105fa1:	e9 1d fb ff ff       	jmp    80105ac3 <alltraps>
...
80105fa6:	6a 00                	push   $0x0
  pushl $5
80105fa8:	6a 05                	push   $0x5
  jmp alltraps
80105faa:	e9 14 fb ff ff       	jmp    80105ac3 <alltraps>
...
80105faf:	6a 00                	push   $0x0
  pushl $6
80105fb1:	6a 06                	push   $0x6
  jmp alltraps
80105fb3:	e9 0b fb ff ff       	jmp    80105ac3 <alltraps>
...
80105fb8:	6a 00                	push   $0x0
  pushl $7
80105fba:	6a 07                	push   $0x7
  jmp alltraps
80105fbc:	e9 02 fb ff ff       	jmp    80105ac3 <alltraps>

80105fc1 <vector8>:
.globl vector8
vector8:
  pushl $8
80105fc1:	6a 08                	push   $0x8
  jmp alltraps
80105fc3:	e9 fb fa ff ff       	jmp    80105ac3 <alltraps>
...
80105fc8:	6a 00                	push   $0x0
  pushl $9
80105fca:	6a 09                	push   $0x9
  jmp alltraps
80105fcc:	e9 f2 fa ff ff       	jmp    80105ac3 <alltraps>

80105fd1 <vector10>:
.globl vector10
vector10:
  pushl $10
80105fd1:	6a 0a                	push   $0xa
  jmp alltraps
80105fd3:	e9 eb fa ff ff       	jmp    80105ac3 <alltraps>

80105fd8 <vector11>:
.globl vector11
vector11:
  pushl $11
80105fd8:	6a 0b                	push   $0xb
  jmp alltraps
80105fda:	e9 e4 fa ff ff       	jmp    80105ac3 <alltraps>

80105fdf <vector12>:
.globl vector12
vector12:
  pushl $12
80105fdf:	6a 0c                	push   $0xc
  jmp alltraps
80105fe1:	e9 dd fa ff ff       	jmp    80105ac3 <alltraps>

80105fe6 <vector13>:
.globl vector13
vector13:
  pushl $13
80105fe6:	6a 0d                	push   $0xd
  jmp alltraps
80105fe8:	e9 d6 fa ff ff       	jmp    80105ac3 <alltraps>

80105fed <vector14>:
.globl vector14
vector14:
  pushl $14
80105fed:	6a 0e                	push   $0xe
  jmp alltraps
80105fef:	e9 cf fa ff ff       	jmp    80105ac3 <alltraps>
...
80105ff4:	6a 00                	push   $0x0
  pushl $15
80105ff6:	6a 0f                	push   $0xf
  jmp alltraps
80105ff8:	e9 c6 fa ff ff       	jmp    80105ac3 <alltraps>
...
80105ffd:	6a 00                	push   $0x0
  pushl $16
80105fff:	6a 10                	push   $0x10
  jmp alltraps
80106001:	e9 bd fa ff ff       	jmp    80105ac3 <alltraps>

80106006 <vector17>:
.globl vector17
vector17:
  pushl $17
80106006:	6a 11                	push   $0x11
  jmp alltraps
80106008:	e9 b6 fa ff ff       	jmp    80105ac3 <alltraps>
...
8010600d:	6a 00                	push   $0x0
  pushl $18
8010600f:	6a 12                	push   $0x12
  jmp alltraps
80106011:	e9 ad fa ff ff       	jmp    80105ac3 <alltraps>
...
80106016:	6a 00                	push   $0x0
  pushl $19
80106018:	6a 13                	push   $0x13
  jmp alltraps
8010601a:	e9 a4 fa ff ff       	jmp    80105ac3 <alltraps>
...
8010601f:	6a 00                	push   $0x0
  pushl $20
80106021:	6a 14                	push   $0x14
  jmp alltraps
80106023:	e9 9b fa ff ff       	jmp    80105ac3 <alltraps>
...
80106028:	6a 00                	push   $0x0
  pushl $21
8010602a:	6a 15                	push   $0x15
  jmp alltraps
8010602c:	e9 92 fa ff ff       	jmp    80105ac3 <alltraps>
...
80106031:	6a 00                	push   $0x0
  pushl $22
80106033:	6a 16                	push   $0x16
  jmp alltraps
80106035:	e9 89 fa ff ff       	jmp    80105ac3 <alltraps>
...
8010603a:	6a 00                	push   $0x0
  pushl $23
8010603c:	6a 17                	push   $0x17
  jmp alltraps
8010603e:	e9 80 fa ff ff       	jmp    80105ac3 <alltraps>
...
80106043:	6a 00                	push   $0x0
  pushl $24
80106045:	6a 18                	push   $0x18
  jmp alltraps
80106047:	e9 77 fa ff ff       	jmp    80105ac3 <alltraps>
...
8010604c:	6a 00                	push   $0x0
  pushl $25
8010604e:	6a 19                	push   $0x19
  jmp alltraps
80106050:	e9 6e fa ff ff       	jmp    80105ac3 <alltraps>
...
80106055:	6a 00                	push   $0x0
  pushl $26
80106057:	6a 1a                	push   $0x1a
  jmp alltraps
80106059:	e9 65 fa ff ff       	jmp    80105ac3 <alltraps>
...
8010605e:	6a 00                	push   $0x0
  pushl $27
80106060:	6a 1b                	push   $0x1b
  jmp alltraps
80106062:	e9 5c fa ff ff       	jmp    80105ac3 <alltraps>
...
80106067:	6a 00                	push   $0x0
  pushl $28
80106069:	6a 1c                	push   $0x1c
  jmp alltraps
8010606b:	e9 53 fa ff ff       	jmp    80105ac3 <alltraps>
...
80106070:	6a 00                	push   $0x0
  pushl $29
80106072:	6a 1d                	push   $0x1d
  jmp alltraps
80106074:	e9 4a fa ff ff       	jmp    80105ac3 <alltraps>
...
80106079:	6a 00                	push   $0x0
  pushl $30
8010607b:	6a 1e                	push   $0x1e
  jmp alltraps
8010607d:	e9 41 fa ff ff       	jmp    80105ac3 <alltraps>
...
80106082:	6a 00                	push   $0x0
  pushl $31
80106084:	6a 1f                	push   $0x1f
  jmp alltraps
80106086:	e9 38 fa ff ff       	jmp    80105ac3 <alltraps>
...
8010608b:	6a 00                	push   $0x0
  pushl $32
8010608d:	6a 20                	push   $0x20
  jmp alltraps
8010608f:	e9 2f fa ff ff       	jmp    80105ac3 <alltraps>
...
80106094:	6a 00                	push   $0x0
  pushl $33
80106096:	6a 21                	push   $0x21
  jmp alltraps
80106098:	e9 26 fa ff ff       	jmp    80105ac3 <alltraps>
...
8010609d:	6a 00                	push   $0x0
  pushl $34
8010609f:	6a 22                	push   $0x22
  jmp alltraps
801060a1:	e9 1d fa ff ff       	jmp    80105ac3 <alltraps>
...
801060a6:	6a 00                	push   $0x0
  pushl $35
801060a8:	6a 23                	push   $0x23
  jmp alltraps
801060aa:	e9 14 fa ff ff       	jmp    80105ac3 <alltraps>
...
801060af:	6a 00                	push   $0x0
  pushl $36
801060b1:	6a 24                	push   $0x24
  jmp alltraps
801060b3:	e9 0b fa ff ff       	jmp    80105ac3 <alltraps>
...
801060b8:	6a 00                	push   $0x0
  pushl $37
801060ba:	6a 25                	push   $0x25
  jmp alltraps
801060bc:	e9 02 fa ff ff       	jmp    80105ac3 <alltraps>
...
801060c1:	6a 00                	push   $0x0
  pushl $38
801060c3:	6a 26                	push   $0x26
  jmp alltraps
801060c5:	e9 f9 f9 ff ff       	jmp    80105ac3 <alltraps>
...
801060ca:	6a 00                	push   $0x0
  pushl $39
801060cc:	6a 27                	push   $0x27
  jmp alltraps
801060ce:	e9 f0 f9 ff ff       	jmp    80105ac3 <alltraps>
...
801060d3:	6a 00                	push   $0x0
  pushl $40
801060d5:	6a 28                	push   $0x28
  jmp alltraps
801060d7:	e9 e7 f9 ff ff       	jmp    80105ac3 <alltraps>
...
801060dc:	6a 00                	push   $0x0
  pushl $41
801060de:	6a 29                	push   $0x29
  jmp alltraps
801060e0:	e9 de f9 ff ff       	jmp    80105ac3 <alltraps>
...
801060e5:	6a 00                	push   $0x0
  pushl $42
801060e7:	6a 2a                	push   $0x2a
  jmp alltraps
801060e9:	e9 d5 f9 ff ff       	jmp    80105ac3 <alltraps>
...
801060ee:	6a 00                	push   $0x0
  pushl $43
801060f0:	6a 2b                	push   $0x2b
  jmp alltraps
801060f2:	e9 cc f9 ff ff       	jmp    80105ac3 <alltraps>
...
801060f7:	6a 00                	push   $0x0
  pushl $44
801060f9:	6a 2c                	push   $0x2c
  jmp alltraps
801060fb:	e9 c3 f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106100:	6a 00                	push   $0x0
  pushl $45
80106102:	6a 2d                	push   $0x2d
  jmp alltraps
80106104:	e9 ba f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106109:	6a 00                	push   $0x0
  pushl $46
8010610b:	6a 2e                	push   $0x2e
  jmp alltraps
8010610d:	e9 b1 f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106112:	6a 00                	push   $0x0
  pushl $47
80106114:	6a 2f                	push   $0x2f
  jmp alltraps
80106116:	e9 a8 f9 ff ff       	jmp    80105ac3 <alltraps>
...
8010611b:	6a 00                	push   $0x0
  pushl $48
8010611d:	6a 30                	push   $0x30
  jmp alltraps
8010611f:	e9 9f f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106124:	6a 00                	push   $0x0
  pushl $49
80106126:	6a 31                	push   $0x31
  jmp alltraps
80106128:	e9 96 f9 ff ff       	jmp    80105ac3 <alltraps>
...
8010612d:	6a 00                	push   $0x0
  pushl $50
8010612f:	6a 32                	push   $0x32
  jmp alltraps
80106131:	e9 8d f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106136:	6a 00                	push   $0x0
  pushl $51
80106138:	6a 33                	push   $0x33
  jmp alltraps
8010613a:	e9 84 f9 ff ff       	jmp    80105ac3 <alltraps>
...
8010613f:	6a 00                	push   $0x0
  pushl $52
80106141:	6a 34                	push   $0x34
  jmp alltraps
80106143:	e9 7b f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106148:	6a 00                	push   $0x0
  pushl $53
8010614a:	6a 35                	push   $0x35
  jmp alltraps
8010614c:	e9 72 f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106151:	6a 00                	push   $0x0
  pushl $54
80106153:	6a 36                	push   $0x36
  jmp alltraps
80106155:	e9 69 f9 ff ff       	jmp    80105ac3 <alltraps>
...
8010615a:	6a 00                	push   $0x0
  pushl $55
8010615c:	6a 37                	push   $0x37
  jmp alltraps
8010615e:	e9 60 f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106163:	6a 00                	push   $0x0
  pushl $56
80106165:	6a 38                	push   $0x38
  jmp alltraps
80106167:	e9 57 f9 ff ff       	jmp    80105ac3 <alltraps>
...
8010616c:	6a 00                	push   $0x0
  pushl $57
8010616e:	6a 39                	push   $0x39
  jmp alltraps
80106170:	e9 4e f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106175:	6a 00                	push   $0x0
  pushl $58
80106177:	6a 3a                	push   $0x3a
  jmp alltraps
80106179:	e9 45 f9 ff ff       	jmp    80105ac3 <alltraps>
...
8010617e:	6a 00                	push   $0x0
  pushl $59
80106180:	6a 3b                	push   $0x3b
  jmp alltraps
80106182:	e9 3c f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106187:	6a 00                	push   $0x0
  pushl $60
80106189:	6a 3c                	push   $0x3c
  jmp alltraps
8010618b:	e9 33 f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106190:	6a 00                	push   $0x0
  pushl $61
80106192:	6a 3d                	push   $0x3d
  jmp alltraps
80106194:	e9 2a f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106199:	6a 00                	push   $0x0
  pushl $62
8010619b:	6a 3e                	push   $0x3e
  jmp alltraps
8010619d:	e9 21 f9 ff ff       	jmp    80105ac3 <alltraps>
...
801061a2:	6a 00                	push   $0x0
  pushl $63
801061a4:	6a 3f                	push   $0x3f
  jmp alltraps
801061a6:	e9 18 f9 ff ff       	jmp    80105ac3 <alltraps>
...
801061ab:	6a 00                	push   $0x0
  pushl $64
801061ad:	6a 40                	push   $0x40
  jmp alltraps
801061af:	e9 0f f9 ff ff       	jmp    80105ac3 <alltraps>
...
801061b4:	6a 00                	push   $0x0
  pushl $65
801061b6:	6a 41                	push   $0x41
  jmp alltraps
801061b8:	e9 06 f9 ff ff       	jmp    80105ac3 <alltraps>
...
801061bd:	6a 00                	push   $0x0
  pushl $66
801061bf:	6a 42                	push   $0x42
  jmp alltraps
801061c1:	e9 fd f8 ff ff       	jmp    80105ac3 <alltraps>
...
801061c6:	6a 00                	push   $0x0
  pushl $67
801061c8:	6a 43                	push   $0x43
  jmp alltraps
801061ca:	e9 f4 f8 ff ff       	jmp    80105ac3 <alltraps>
...
801061cf:	6a 00                	push   $0x0
  pushl $68
801061d1:	6a 44                	push   $0x44
  jmp alltraps
801061d3:	e9 eb f8 ff ff       	jmp    80105ac3 <alltraps>
...
801061d8:	6a 00                	push   $0x0
  pushl $69
801061da:	6a 45                	push   $0x45
  jmp alltraps
801061dc:	e9 e2 f8 ff ff       	jmp    80105ac3 <alltraps>
...
801061e1:	6a 00                	push   $0x0
  pushl $70
801061e3:	6a 46                	push   $0x46
  jmp alltraps
801061e5:	e9 d9 f8 ff ff       	jmp    80105ac3 <alltraps>
...
801061ea:	6a 00                	push   $0x0
  pushl $71
801061ec:	6a 47                	push   $0x47
  jmp alltraps
801061ee:	e9 d0 f8 ff ff       	jmp    80105ac3 <alltraps>
...
801061f3:	6a 00                	push   $0x0
  pushl $72
801061f5:	6a 48                	push   $0x48
  jmp alltraps
801061f7:	e9 c7 f8 ff ff       	jmp    80105ac3 <alltraps>
...
801061fc:	6a 00                	push   $0x0
  pushl $73
801061fe:	6a 49                	push   $0x49
  jmp alltraps
80106200:	e9 be f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106205:	6a 00                	push   $0x0
  pushl $74
80106207:	6a 4a                	push   $0x4a
  jmp alltraps
80106209:	e9 b5 f8 ff ff       	jmp    80105ac3 <alltraps>
...
8010620e:	6a 00                	push   $0x0
  pushl $75
80106210:	6a 4b                	push   $0x4b
  jmp alltraps
80106212:	e9 ac f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106217:	6a 00                	push   $0x0
  pushl $76
80106219:	6a 4c                	push   $0x4c
  jmp alltraps
8010621b:	e9 a3 f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106220:	6a 00                	push   $0x0
  pushl $77
80106222:	6a 4d                	push   $0x4d
  jmp alltraps
80106224:	e9 9a f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106229:	6a 00                	push   $0x0
  pushl $78
8010622b:	6a 4e                	push   $0x4e
  jmp alltraps
8010622d:	e9 91 f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106232:	6a 00                	push   $0x0
  pushl $79
80106234:	6a 4f                	push   $0x4f
  jmp alltraps
80106236:	e9 88 f8 ff ff       	jmp    80105ac3 <alltraps>
...
8010623b:	6a 00                	push   $0x0
  pushl $80
8010623d:	6a 50                	push   $0x50
  jmp alltraps
8010623f:	e9 7f f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106244:	6a 00                	push   $0x0
  pushl $81
80106246:	6a 51                	push   $0x51
  jmp alltraps
80106248:	e9 76 f8 ff ff       	jmp    80105ac3 <alltraps>
...
8010624d:	6a 00                	push   $0x0
  pushl $82
8010624f:	6a 52                	push   $0x52
  jmp alltraps
80106251:	e9 6d f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106256:	6a 00                	push   $0x0
  pushl $83
80106258:	6a 53                	push   $0x53
  jmp alltraps
8010625a:	e9 64 f8 ff ff       	jmp    80105ac3 <alltraps>
...
8010625f:	6a 00                	push   $0x0
  pushl $84
80106261:	6a 54                	push   $0x54
  jmp alltraps
80106263:	e9 5b f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106268:	6a 00                	push   $0x0
  pushl $85
8010626a:	6a 55                	push   $0x55
  jmp alltraps
8010626c:	e9 52 f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106271:	6a 00                	push   $0x0
  pushl $86
80106273:	6a 56                	push   $0x56
  jmp alltraps
80106275:	e9 49 f8 ff ff       	jmp    80105ac3 <alltraps>
...
8010627a:	6a 00                	push   $0x0
  pushl $87
8010627c:	6a 57                	push   $0x57
  jmp alltraps
8010627e:	e9 40 f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106283:	6a 00                	push   $0x0
  pushl $88
80106285:	6a 58                	push   $0x58
  jmp alltraps
80106287:	e9 37 f8 ff ff       	jmp    80105ac3 <alltraps>
...
8010628c:	6a 00                	push   $0x0
  pushl $89
8010628e:	6a 59                	push   $0x59
  jmp alltraps
80106290:	e9 2e f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106295:	6a 00                	push   $0x0
  pushl $90
80106297:	6a 5a                	push   $0x5a
  jmp alltraps
80106299:	e9 25 f8 ff ff       	jmp    80105ac3 <alltraps>
...
8010629e:	6a 00                	push   $0x0
  pushl $91
801062a0:	6a 5b                	push   $0x5b
  jmp alltraps
801062a2:	e9 1c f8 ff ff       	jmp    80105ac3 <alltraps>
...
801062a7:	6a 00                	push   $0x0
  pushl $92
801062a9:	6a 5c                	push   $0x5c
  jmp alltraps
801062ab:	e9 13 f8 ff ff       	jmp    80105ac3 <alltraps>
...
801062b0:	6a 00                	push   $0x0
  pushl $93
801062b2:	6a 5d                	push   $0x5d
  jmp alltraps
801062b4:	e9 0a f8 ff ff       	jmp    80105ac3 <alltraps>
...
801062b9:	6a 00                	push   $0x0
  pushl $94
801062bb:	6a 5e                	push   $0x5e
  jmp alltraps
801062bd:	e9 01 f8 ff ff       	jmp    80105ac3 <alltraps>
...
801062c2:	6a 00                	push   $0x0
  pushl $95
801062c4:	6a 5f                	push   $0x5f
  jmp alltraps
801062c6:	e9 f8 f7 ff ff       	jmp    80105ac3 <alltraps>
...
801062cb:	6a 00                	push   $0x0
  pushl $96
801062cd:	6a 60                	push   $0x60
  jmp alltraps
801062cf:	e9 ef f7 ff ff       	jmp    80105ac3 <alltraps>
...
801062d4:	6a 00                	push   $0x0
  pushl $97
801062d6:	6a 61                	push   $0x61
  jmp alltraps
801062d8:	e9 e6 f7 ff ff       	jmp    80105ac3 <alltraps>
...
801062dd:	6a 00                	push   $0x0
  pushl $98
801062df:	6a 62                	push   $0x62
  jmp alltraps
801062e1:	e9 dd f7 ff ff       	jmp    80105ac3 <alltraps>
...
801062e6:	6a 00                	push   $0x0
  pushl $99
801062e8:	6a 63                	push   $0x63
  jmp alltraps
801062ea:	e9 d4 f7 ff ff       	jmp    80105ac3 <alltraps>
...
801062ef:	6a 00                	push   $0x0
  pushl $100
801062f1:	6a 64                	push   $0x64
  jmp alltraps
801062f3:	e9 cb f7 ff ff       	jmp    80105ac3 <alltraps>
...
801062f8:	6a 00                	push   $0x0
  pushl $101
801062fa:	6a 65                	push   $0x65
  jmp alltraps
801062fc:	e9 c2 f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106301:	6a 00                	push   $0x0
  pushl $102
80106303:	6a 66                	push   $0x66
  jmp alltraps
80106305:	e9 b9 f7 ff ff       	jmp    80105ac3 <alltraps>
...
8010630a:	6a 00                	push   $0x0
  pushl $103
8010630c:	6a 67                	push   $0x67
  jmp alltraps
8010630e:	e9 b0 f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106313:	6a 00                	push   $0x0
  pushl $104
80106315:	6a 68                	push   $0x68
  jmp alltraps
80106317:	e9 a7 f7 ff ff       	jmp    80105ac3 <alltraps>
...
8010631c:	6a 00                	push   $0x0
  pushl $105
8010631e:	6a 69                	push   $0x69
  jmp alltraps
80106320:	e9 9e f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106325:	6a 00                	push   $0x0
  pushl $106
80106327:	6a 6a                	push   $0x6a
  jmp alltraps
80106329:	e9 95 f7 ff ff       	jmp    80105ac3 <alltraps>
...
8010632e:	6a 00                	push   $0x0
  pushl $107
80106330:	6a 6b                	push   $0x6b
  jmp alltraps
80106332:	e9 8c f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106337:	6a 00                	push   $0x0
  pushl $108
80106339:	6a 6c                	push   $0x6c
  jmp alltraps
8010633b:	e9 83 f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106340:	6a 00                	push   $0x0
  pushl $109
80106342:	6a 6d                	push   $0x6d
  jmp alltraps
80106344:	e9 7a f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106349:	6a 00                	push   $0x0
  pushl $110
8010634b:	6a 6e                	push   $0x6e
  jmp alltraps
8010634d:	e9 71 f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106352:	6a 00                	push   $0x0
  pushl $111
80106354:	6a 6f                	push   $0x6f
  jmp alltraps
80106356:	e9 68 f7 ff ff       	jmp    80105ac3 <alltraps>
...
8010635b:	6a 00                	push   $0x0
  pushl $112
8010635d:	6a 70                	push   $0x70
  jmp alltraps
8010635f:	e9 5f f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106364:	6a 00                	push   $0x0
  pushl $113
80106366:	6a 71                	push   $0x71
  jmp alltraps
80106368:	e9 56 f7 ff ff       	jmp    80105ac3 <alltraps>
...
8010636d:	6a 00                	push   $0x0
  pushl $114
8010636f:	6a 72                	push   $0x72
  jmp alltraps
80106371:	e9 4d f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106376:	6a 00                	push   $0x0
  pushl $115
80106378:	6a 73                	push   $0x73
  jmp alltraps
8010637a:	e9 44 f7 ff ff       	jmp    80105ac3 <alltraps>
...
8010637f:	6a 00                	push   $0x0
  pushl $116
80106381:	6a 74                	push   $0x74
  jmp alltraps
80106383:	e9 3b f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106388:	6a 00                	push   $0x0
  pushl $117
8010638a:	6a 75                	push   $0x75
  jmp alltraps
8010638c:	e9 32 f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106391:	6a 00                	push   $0x0
  pushl $118
80106393:	6a 76                	push   $0x76
  jmp alltraps
80106395:	e9 29 f7 ff ff       	jmp    80105ac3 <alltraps>
...
8010639a:	6a 00                	push   $0x0
  pushl $119
8010639c:	6a 77                	push   $0x77
  jmp alltraps
8010639e:	e9 20 f7 ff ff       	jmp    80105ac3 <alltraps>
...
801063a3:	6a 00                	push   $0x0
  pushl $120
801063a5:	6a 78                	push   $0x78
  jmp alltraps
801063a7:	e9 17 f7 ff ff       	jmp    80105ac3 <alltraps>
...
801063ac:	6a 00                	push   $0x0
  pushl $121
801063ae:	6a 79                	push   $0x79
  jmp alltraps
801063b0:	e9 0e f7 ff ff       	jmp    80105ac3 <alltraps>
...
801063b5:	6a 00                	push   $0x0
  pushl $122
801063b7:	6a 7a                	push   $0x7a
  jmp alltraps
801063b9:	e9 05 f7 ff ff       	jmp    80105ac3 <alltraps>
...
801063be:	6a 00                	push   $0x0
  pushl $123
801063c0:	6a 7b                	push   $0x7b
  jmp alltraps
801063c2:	e9 fc f6 ff ff       	jmp    80105ac3 <alltraps>
...
801063c7:	6a 00                	push   $0x0
  pushl $124
801063c9:	6a 7c                	push   $0x7c
  jmp alltraps
801063cb:	e9 f3 f6 ff ff       	jmp    80105ac3 <alltraps>
...
801063d0:	6a 00                	push   $0x0
  pushl $125
801063d2:	6a 7d                	push   $0x7d
  jmp alltraps
801063d4:	e9 ea f6 ff ff       	jmp    80105ac3 <alltraps>
...
801063d9:	6a 00                	push   $0x0
  pushl $126
801063db:	6a 7e                	push   $0x7e
  jmp alltraps
801063dd:	e9 e1 f6 ff ff       	jmp    80105ac3 <alltraps>
...
801063e2:	6a 00                	push   $0x0
  pushl $127
801063e4:	6a 7f                	push   $0x7f
  jmp alltraps
801063e6:	e9 d8 f6 ff ff       	jmp    80105ac3 <alltraps>
...
801063eb:	6a 00                	push   $0x0
  pushl $128
801063ed:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801063f2:	e9 cc f6 ff ff       	jmp    80105ac3 <alltraps>
...
801063f7:	6a 00                	push   $0x0
  pushl $129
801063f9:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801063fe:	e9 c0 f6 ff ff       	jmp    80105ac3 <alltraps>
...
80106403:	6a 00                	push   $0x0
  pushl $130
80106405:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010640a:	e9 b4 f6 ff ff       	jmp    80105ac3 <alltraps>
...
8010640f:	6a 00                	push   $0x0
  pushl $131
80106411:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106416:	e9 a8 f6 ff ff       	jmp    80105ac3 <alltraps>
...
8010641b:	6a 00                	push   $0x0
  pushl $132
8010641d:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106422:	e9 9c f6 ff ff       	jmp    80105ac3 <alltraps>
...
80106427:	6a 00                	push   $0x0
  pushl $133
80106429:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010642e:	e9 90 f6 ff ff       	jmp    80105ac3 <alltraps>
...
80106433:	6a 00                	push   $0x0
  pushl $134
80106435:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010643a:	e9 84 f6 ff ff       	jmp    80105ac3 <alltraps>
...
8010643f:	6a 00                	push   $0x0
  pushl $135
80106441:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106446:	e9 78 f6 ff ff       	jmp    80105ac3 <alltraps>
...
8010644b:	6a 00                	push   $0x0
  pushl $136
8010644d:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106452:	e9 6c f6 ff ff       	jmp    80105ac3 <alltraps>
...
80106457:	6a 00                	push   $0x0
  pushl $137
80106459:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010645e:	e9 60 f6 ff ff       	jmp    80105ac3 <alltraps>
...
80106463:	6a 00                	push   $0x0
  pushl $138
80106465:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010646a:	e9 54 f6 ff ff       	jmp    80105ac3 <alltraps>
...
8010646f:	6a 00                	push   $0x0
  pushl $139
80106471:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106476:	e9 48 f6 ff ff       	jmp    80105ac3 <alltraps>
...
8010647b:	6a 00                	push   $0x0
  pushl $140
8010647d:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106482:	e9 3c f6 ff ff       	jmp    80105ac3 <alltraps>
...
80106487:	6a 00                	push   $0x0
  pushl $141
80106489:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010648e:	e9 30 f6 ff ff       	jmp    80105ac3 <alltraps>
...
80106493:	6a 00                	push   $0x0
  pushl $142
80106495:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010649a:	e9 24 f6 ff ff       	jmp    80105ac3 <alltraps>
...
8010649f:	6a 00                	push   $0x0
  pushl $143
801064a1:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801064a6:	e9 18 f6 ff ff       	jmp    80105ac3 <alltraps>
...
801064ab:	6a 00                	push   $0x0
  pushl $144
801064ad:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801064b2:	e9 0c f6 ff ff       	jmp    80105ac3 <alltraps>
...
801064b7:	6a 00                	push   $0x0
  pushl $145
801064b9:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801064be:	e9 00 f6 ff ff       	jmp    80105ac3 <alltraps>
...
801064c3:	6a 00                	push   $0x0
  pushl $146
801064c5:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801064ca:	e9 f4 f5 ff ff       	jmp    80105ac3 <alltraps>
...
801064cf:	6a 00                	push   $0x0
  pushl $147
801064d1:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801064d6:	e9 e8 f5 ff ff       	jmp    80105ac3 <alltraps>
...
801064db:	6a 00                	push   $0x0
  pushl $148
801064dd:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801064e2:	e9 dc f5 ff ff       	jmp    80105ac3 <alltraps>
...
801064e7:	6a 00                	push   $0x0
  pushl $149
801064e9:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801064ee:	e9 d0 f5 ff ff       	jmp    80105ac3 <alltraps>
...
801064f3:	6a 00                	push   $0x0
  pushl $150
801064f5:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801064fa:	e9 c4 f5 ff ff       	jmp    80105ac3 <alltraps>
...
801064ff:	6a 00                	push   $0x0
  pushl $151
80106501:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106506:	e9 b8 f5 ff ff       	jmp    80105ac3 <alltraps>
...
8010650b:	6a 00                	push   $0x0
  pushl $152
8010650d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106512:	e9 ac f5 ff ff       	jmp    80105ac3 <alltraps>
...
80106517:	6a 00                	push   $0x0
  pushl $153
80106519:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010651e:	e9 a0 f5 ff ff       	jmp    80105ac3 <alltraps>
...
80106523:	6a 00                	push   $0x0
  pushl $154
80106525:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010652a:	e9 94 f5 ff ff       	jmp    80105ac3 <alltraps>
...
8010652f:	6a 00                	push   $0x0
  pushl $155
80106531:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106536:	e9 88 f5 ff ff       	jmp    80105ac3 <alltraps>
...
8010653b:	6a 00                	push   $0x0
  pushl $156
8010653d:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106542:	e9 7c f5 ff ff       	jmp    80105ac3 <alltraps>
...
80106547:	6a 00                	push   $0x0
  pushl $157
80106549:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010654e:	e9 70 f5 ff ff       	jmp    80105ac3 <alltraps>
...
80106553:	6a 00                	push   $0x0
  pushl $158
80106555:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010655a:	e9 64 f5 ff ff       	jmp    80105ac3 <alltraps>
...
8010655f:	6a 00                	push   $0x0
  pushl $159
80106561:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106566:	e9 58 f5 ff ff       	jmp    80105ac3 <alltraps>
...
8010656b:	6a 00                	push   $0x0
  pushl $160
8010656d:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106572:	e9 4c f5 ff ff       	jmp    80105ac3 <alltraps>
...
80106577:	6a 00                	push   $0x0
  pushl $161
80106579:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010657e:	e9 40 f5 ff ff       	jmp    80105ac3 <alltraps>
...
80106583:	6a 00                	push   $0x0
  pushl $162
80106585:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010658a:	e9 34 f5 ff ff       	jmp    80105ac3 <alltraps>
...
8010658f:	6a 00                	push   $0x0
  pushl $163
80106591:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106596:	e9 28 f5 ff ff       	jmp    80105ac3 <alltraps>
...
8010659b:	6a 00                	push   $0x0
  pushl $164
8010659d:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801065a2:	e9 1c f5 ff ff       	jmp    80105ac3 <alltraps>
...
801065a7:	6a 00                	push   $0x0
  pushl $165
801065a9:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801065ae:	e9 10 f5 ff ff       	jmp    80105ac3 <alltraps>
...
801065b3:	6a 00                	push   $0x0
  pushl $166
801065b5:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801065ba:	e9 04 f5 ff ff       	jmp    80105ac3 <alltraps>
...
801065bf:	6a 00                	push   $0x0
  pushl $167
801065c1:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801065c6:	e9 f8 f4 ff ff       	jmp    80105ac3 <alltraps>
...
801065cb:	6a 00                	push   $0x0
  pushl $168
801065cd:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801065d2:	e9 ec f4 ff ff       	jmp    80105ac3 <alltraps>
...
801065d7:	6a 00                	push   $0x0
  pushl $169
801065d9:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801065de:	e9 e0 f4 ff ff       	jmp    80105ac3 <alltraps>
...
801065e3:	6a 00                	push   $0x0
  pushl $170
801065e5:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801065ea:	e9 d4 f4 ff ff       	jmp    80105ac3 <alltraps>
...
801065ef:	6a 00                	push   $0x0
  pushl $171
801065f1:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801065f6:	e9 c8 f4 ff ff       	jmp    80105ac3 <alltraps>
...
801065fb:	6a 00                	push   $0x0
  pushl $172
801065fd:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106602:	e9 bc f4 ff ff       	jmp    80105ac3 <alltraps>
...
80106607:	6a 00                	push   $0x0
  pushl $173
80106609:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010660e:	e9 b0 f4 ff ff       	jmp    80105ac3 <alltraps>
...
80106613:	6a 00                	push   $0x0
  pushl $174
80106615:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010661a:	e9 a4 f4 ff ff       	jmp    80105ac3 <alltraps>
...
8010661f:	6a 00                	push   $0x0
  pushl $175
80106621:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106626:	e9 98 f4 ff ff       	jmp    80105ac3 <alltraps>
...
8010662b:	6a 00                	push   $0x0
  pushl $176
8010662d:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106632:	e9 8c f4 ff ff       	jmp    80105ac3 <alltraps>
...
80106637:	6a 00                	push   $0x0
  pushl $177
80106639:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010663e:	e9 80 f4 ff ff       	jmp    80105ac3 <alltraps>
...
80106643:	6a 00                	push   $0x0
  pushl $178
80106645:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010664a:	e9 74 f4 ff ff       	jmp    80105ac3 <alltraps>
...
8010664f:	6a 00                	push   $0x0
  pushl $179
80106651:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106656:	e9 68 f4 ff ff       	jmp    80105ac3 <alltraps>
...
8010665b:	6a 00                	push   $0x0
  pushl $180
8010665d:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106662:	e9 5c f4 ff ff       	jmp    80105ac3 <alltraps>
...
80106667:	6a 00                	push   $0x0
  pushl $181
80106669:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010666e:	e9 50 f4 ff ff       	jmp    80105ac3 <alltraps>
...
80106673:	6a 00                	push   $0x0
  pushl $182
80106675:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010667a:	e9 44 f4 ff ff       	jmp    80105ac3 <alltraps>
...
8010667f:	6a 00                	push   $0x0
  pushl $183
80106681:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106686:	e9 38 f4 ff ff       	jmp    80105ac3 <alltraps>
...
8010668b:	6a 00                	push   $0x0
  pushl $184
8010668d:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106692:	e9 2c f4 ff ff       	jmp    80105ac3 <alltraps>
...
80106697:	6a 00                	push   $0x0
  pushl $185
80106699:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010669e:	e9 20 f4 ff ff       	jmp    80105ac3 <alltraps>
...
801066a3:	6a 00                	push   $0x0
  pushl $186
801066a5:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801066aa:	e9 14 f4 ff ff       	jmp    80105ac3 <alltraps>
...
801066af:	6a 00                	push   $0x0
  pushl $187
801066b1:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801066b6:	e9 08 f4 ff ff       	jmp    80105ac3 <alltraps>
...
801066bb:	6a 00                	push   $0x0
  pushl $188
801066bd:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801066c2:	e9 fc f3 ff ff       	jmp    80105ac3 <alltraps>
...
801066c7:	6a 00                	push   $0x0
  pushl $189
801066c9:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801066ce:	e9 f0 f3 ff ff       	jmp    80105ac3 <alltraps>
...
801066d3:	6a 00                	push   $0x0
  pushl $190
801066d5:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801066da:	e9 e4 f3 ff ff       	jmp    80105ac3 <alltraps>
...
801066df:	6a 00                	push   $0x0
  pushl $191
801066e1:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801066e6:	e9 d8 f3 ff ff       	jmp    80105ac3 <alltraps>
...
801066eb:	6a 00                	push   $0x0
  pushl $192
801066ed:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801066f2:	e9 cc f3 ff ff       	jmp    80105ac3 <alltraps>
...
801066f7:	6a 00                	push   $0x0
  pushl $193
801066f9:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801066fe:	e9 c0 f3 ff ff       	jmp    80105ac3 <alltraps>
...
80106703:	6a 00                	push   $0x0
  pushl $194
80106705:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010670a:	e9 b4 f3 ff ff       	jmp    80105ac3 <alltraps>
...
8010670f:	6a 00                	push   $0x0
  pushl $195
80106711:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106716:	e9 a8 f3 ff ff       	jmp    80105ac3 <alltraps>
...
8010671b:	6a 00                	push   $0x0
  pushl $196
8010671d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106722:	e9 9c f3 ff ff       	jmp    80105ac3 <alltraps>
...
80106727:	6a 00                	push   $0x0
  pushl $197
80106729:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010672e:	e9 90 f3 ff ff       	jmp    80105ac3 <alltraps>
...
80106733:	6a 00                	push   $0x0
  pushl $198
80106735:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010673a:	e9 84 f3 ff ff       	jmp    80105ac3 <alltraps>
...
8010673f:	6a 00                	push   $0x0
  pushl $199
80106741:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106746:	e9 78 f3 ff ff       	jmp    80105ac3 <alltraps>
...
8010674b:	6a 00                	push   $0x0
  pushl $200
8010674d:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106752:	e9 6c f3 ff ff       	jmp    80105ac3 <alltraps>
...
80106757:	6a 00                	push   $0x0
  pushl $201
80106759:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010675e:	e9 60 f3 ff ff       	jmp    80105ac3 <alltraps>
...
80106763:	6a 00                	push   $0x0
  pushl $202
80106765:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010676a:	e9 54 f3 ff ff       	jmp    80105ac3 <alltraps>
...
8010676f:	6a 00                	push   $0x0
  pushl $203
80106771:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106776:	e9 48 f3 ff ff       	jmp    80105ac3 <alltraps>
...
8010677b:	6a 00                	push   $0x0
  pushl $204
8010677d:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106782:	e9 3c f3 ff ff       	jmp    80105ac3 <alltraps>
...
80106787:	6a 00                	push   $0x0
  pushl $205
80106789:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010678e:	e9 30 f3 ff ff       	jmp    80105ac3 <alltraps>
...
80106793:	6a 00                	push   $0x0
  pushl $206
80106795:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010679a:	e9 24 f3 ff ff       	jmp    80105ac3 <alltraps>
...
8010679f:	6a 00                	push   $0x0
  pushl $207
801067a1:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801067a6:	e9 18 f3 ff ff       	jmp    80105ac3 <alltraps>
...
801067ab:	6a 00                	push   $0x0
  pushl $208
801067ad:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801067b2:	e9 0c f3 ff ff       	jmp    80105ac3 <alltraps>
...
801067b7:	6a 00                	push   $0x0
  pushl $209
801067b9:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801067be:	e9 00 f3 ff ff       	jmp    80105ac3 <alltraps>
...
801067c3:	6a 00                	push   $0x0
  pushl $210
801067c5:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801067ca:	e9 f4 f2 ff ff       	jmp    80105ac3 <alltraps>
...
801067cf:	6a 00                	push   $0x0
  pushl $211
801067d1:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801067d6:	e9 e8 f2 ff ff       	jmp    80105ac3 <alltraps>
...
801067db:	6a 00                	push   $0x0
  pushl $212
801067dd:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801067e2:	e9 dc f2 ff ff       	jmp    80105ac3 <alltraps>
...
801067e7:	6a 00                	push   $0x0
  pushl $213
801067e9:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801067ee:	e9 d0 f2 ff ff       	jmp    80105ac3 <alltraps>
...
801067f3:	6a 00                	push   $0x0
  pushl $214
801067f5:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801067fa:	e9 c4 f2 ff ff       	jmp    80105ac3 <alltraps>
...
801067ff:	6a 00                	push   $0x0
  pushl $215
80106801:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106806:	e9 b8 f2 ff ff       	jmp    80105ac3 <alltraps>
...
8010680b:	6a 00                	push   $0x0
  pushl $216
8010680d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106812:	e9 ac f2 ff ff       	jmp    80105ac3 <alltraps>
...
80106817:	6a 00                	push   $0x0
  pushl $217
80106819:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010681e:	e9 a0 f2 ff ff       	jmp    80105ac3 <alltraps>
...
80106823:	6a 00                	push   $0x0
  pushl $218
80106825:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010682a:	e9 94 f2 ff ff       	jmp    80105ac3 <alltraps>
...
8010682f:	6a 00                	push   $0x0
  pushl $219
80106831:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106836:	e9 88 f2 ff ff       	jmp    80105ac3 <alltraps>
...
8010683b:	6a 00                	push   $0x0
  pushl $220
8010683d:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106842:	e9 7c f2 ff ff       	jmp    80105ac3 <alltraps>
...
80106847:	6a 00                	push   $0x0
  pushl $221
80106849:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010684e:	e9 70 f2 ff ff       	jmp    80105ac3 <alltraps>
...
80106853:	6a 00                	push   $0x0
  pushl $222
80106855:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010685a:	e9 64 f2 ff ff       	jmp    80105ac3 <alltraps>
...
8010685f:	6a 00                	push   $0x0
  pushl $223
80106861:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106866:	e9 58 f2 ff ff       	jmp    80105ac3 <alltraps>
...
8010686b:	6a 00                	push   $0x0
  pushl $224
8010686d:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106872:	e9 4c f2 ff ff       	jmp    80105ac3 <alltraps>
...
80106877:	6a 00                	push   $0x0
  pushl $225
80106879:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010687e:	e9 40 f2 ff ff       	jmp    80105ac3 <alltraps>
...
80106883:	6a 00                	push   $0x0
  pushl $226
80106885:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
8010688a:	e9 34 f2 ff ff       	jmp    80105ac3 <alltraps>
...
8010688f:	6a 00                	push   $0x0
  pushl $227
80106891:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106896:	e9 28 f2 ff ff       	jmp    80105ac3 <alltraps>
...
8010689b:	6a 00                	push   $0x0
  pushl $228
8010689d:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801068a2:	e9 1c f2 ff ff       	jmp    80105ac3 <alltraps>
...
801068a7:	6a 00                	push   $0x0
  pushl $229
801068a9:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801068ae:	e9 10 f2 ff ff       	jmp    80105ac3 <alltraps>
...
801068b3:	6a 00                	push   $0x0
  pushl $230
801068b5:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801068ba:	e9 04 f2 ff ff       	jmp    80105ac3 <alltraps>
...
801068bf:	6a 00                	push   $0x0
  pushl $231
801068c1:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801068c6:	e9 f8 f1 ff ff       	jmp    80105ac3 <alltraps>
...
801068cb:	6a 00                	push   $0x0
  pushl $232
801068cd:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801068d2:	e9 ec f1 ff ff       	jmp    80105ac3 <alltraps>
...
801068d7:	6a 00                	push   $0x0
  pushl $233
801068d9:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801068de:	e9 e0 f1 ff ff       	jmp    80105ac3 <alltraps>
...
801068e3:	6a 00                	push   $0x0
  pushl $234
801068e5:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801068ea:	e9 d4 f1 ff ff       	jmp    80105ac3 <alltraps>
...
801068ef:	6a 00                	push   $0x0
  pushl $235
801068f1:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801068f6:	e9 c8 f1 ff ff       	jmp    80105ac3 <alltraps>
...
801068fb:	6a 00                	push   $0x0
  pushl $236
801068fd:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106902:	e9 bc f1 ff ff       	jmp    80105ac3 <alltraps>
...
80106907:	6a 00                	push   $0x0
  pushl $237
80106909:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010690e:	e9 b0 f1 ff ff       	jmp    80105ac3 <alltraps>
...
80106913:	6a 00                	push   $0x0
  pushl $238
80106915:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
8010691a:	e9 a4 f1 ff ff       	jmp    80105ac3 <alltraps>
...
8010691f:	6a 00                	push   $0x0
  pushl $239
80106921:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106926:	e9 98 f1 ff ff       	jmp    80105ac3 <alltraps>
...
8010692b:	6a 00                	push   $0x0
  pushl $240
8010692d:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106932:	e9 8c f1 ff ff       	jmp    80105ac3 <alltraps>
...
80106937:	6a 00                	push   $0x0
  pushl $241
80106939:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010693e:	e9 80 f1 ff ff       	jmp    80105ac3 <alltraps>
...
80106943:	6a 00                	push   $0x0
  pushl $242
80106945:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010694a:	e9 74 f1 ff ff       	jmp    80105ac3 <alltraps>
...
8010694f:	6a 00                	push   $0x0
  pushl $243
80106951:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106956:	e9 68 f1 ff ff       	jmp    80105ac3 <alltraps>
...
8010695b:	6a 00                	push   $0x0
  pushl $244
8010695d:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106962:	e9 5c f1 ff ff       	jmp    80105ac3 <alltraps>
...
80106967:	6a 00                	push   $0x0
  pushl $245
80106969:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010696e:	e9 50 f1 ff ff       	jmp    80105ac3 <alltraps>
...
80106973:	6a 00                	push   $0x0
  pushl $246
80106975:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
8010697a:	e9 44 f1 ff ff       	jmp    80105ac3 <alltraps>
...
8010697f:	6a 00                	push   $0x0
  pushl $247
80106981:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106986:	e9 38 f1 ff ff       	jmp    80105ac3 <alltraps>
...
8010698b:	6a 00                	push   $0x0
  pushl $248
8010698d:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106992:	e9 2c f1 ff ff       	jmp    80105ac3 <alltraps>
...
80106997:	6a 00                	push   $0x0
  pushl $249
80106999:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010699e:	e9 20 f1 ff ff       	jmp    80105ac3 <alltraps>
...
801069a3:	6a 00                	push   $0x0
  pushl $250
801069a5:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801069aa:	e9 14 f1 ff ff       	jmp    80105ac3 <alltraps>
...
801069af:	6a 00                	push   $0x0
  pushl $251
801069b1:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801069b6:	e9 08 f1 ff ff       	jmp    80105ac3 <alltraps>
...
801069bb:	6a 00                	push   $0x0
  pushl $252
801069bd:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801069c2:	e9 fc f0 ff ff       	jmp    80105ac3 <alltraps>
...
801069c7:	6a 00                	push   $0x0
  pushl $253
801069c9:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801069ce:	e9 f0 f0 ff ff       	jmp    80105ac3 <alltraps>
...
801069d3:	6a 00                	push   $0x0
  pushl $254
801069d5:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801069da:	e9 e4 f0 ff ff       	jmp    80105ac3 <alltraps>
...
801069df:	6a 00                	push   $0x0
  pushl $255
801069e1:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801069e6:	e9 d8 f0 ff ff       	jmp    80105ac3 <alltraps>
801069eb:	66 90                	xchg   %ax,%ax
801069ed:	66 90                	xchg   %ax,%ax
801069ef:	90                   	nop
...
801069f5:	89 d6                	mov    %edx,%esi
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
801069f7:	c1 ea 16             	shr    $0x16,%edx
{
801069fa:	53                   	push   %ebx
  pde = &pgdir[PDX(va)];
801069fb:	8d 3c 90             	lea    (%eax,%edx,4),%edi
{
801069fe:	83 ec 0c             	sub    $0xc,%esp
  if(*pde & PTE_P){
80106a01:	8b 1f                	mov    (%edi),%ebx
80106a03:	f6 c3 01             	test   $0x1,%bl
80106a06:	74 28                	je     80106a30 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106a08:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80106a0e:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
...
80106a16:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return &pgtab[PTX(va)];
80106a19:	c1 e8 0a             	shr    $0xa,%eax
80106a1c:	25 fc 0f 00 00       	and    $0xffc,%eax
80106a21:	01 d8                	add    %ebx,%eax
}
80106a23:	5b                   	pop    %ebx
80106a24:	5e                   	pop    %esi
80106a25:	5f                   	pop    %edi
...
80106a30:	85 c9                	test   %ecx,%ecx
80106a32:	74 2c                	je     80106a60 <walkpgdir+0x70>
80106a34:	e8 f7 bb ff ff       	call   80102630 <kalloc>
80106a39:	89 c3                	mov    %eax,%ebx
80106a3b:	85 c0                	test   %eax,%eax
80106a3d:	74 21                	je     80106a60 <walkpgdir+0x70>
    memset(pgtab, 0, PGSIZE);
80106a3f:	83 ec 04             	sub    $0x4,%esp
80106a42:	68 00 10 00 00       	push   $0x1000
80106a47:	6a 00                	push   $0x0
80106a49:	50                   	push   %eax
80106a4a:	e8 91 dd ff ff       	call   801047e0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106a4f:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106a55:	83 c4 10             	add    $0x10,%esp
80106a58:	83 c8 07             	or     $0x7,%eax
80106a5b:	89 07                	mov    %eax,(%edi)
80106a5d:	eb b5                	jmp    80106a14 <walkpgdir+0x24>
80106a5f:	90                   	nop
}
...
80106a76:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
{
80106a7a:	56                   	push   %esi
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106a7b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  a = (char*)PGROUNDDOWN((uint)va);
80106a80:	89 d6                	mov    %edx,%esi
{
80106a82:	53                   	push   %ebx
  a = (char*)PGROUNDDOWN((uint)va);
80106a83:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
{
80106a89:	83 ec 1c             	sub    $0x1c,%esp
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
...
80106a97:	eb 1f                	jmp    80106ab8 <mappages+0x48>
...
80106aa3:	75 45                	jne    80106aea <mappages+0x7a>
      panic("remap");
    *pte = pa | perm | PTE_P;
80106aa5:	0b 5d 0c             	or     0xc(%ebp),%ebx
80106aa8:	83 cb 01             	or     $0x1,%ebx
80106aab:	89 18                	mov    %ebx,(%eax)
    if(a == last)
80106aad:	3b 75 e0             	cmp    -0x20(%ebp),%esi
80106ab0:	74 2e                	je     80106ae0 <mappages+0x70>
      break;
    a += PGSIZE;
80106ab2:	81 c6 00 10 00 00    	add    $0x1000,%esi
  for(;;){
80106ab8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80106abb:	b9 01 00 00 00       	mov    $0x1,%ecx
80106ac0:	89 f2                	mov    %esi,%edx
80106ac2:	8d 1c 06             	lea    (%esi,%eax,1),%ebx
80106ac5:	89 f8                	mov    %edi,%eax
80106ac7:	e8 24 ff ff ff       	call   801069f0 <walkpgdir>
80106acc:	85 c0                	test   %eax,%eax
80106ace:	75 d0                	jne    80106aa0 <mappages+0x30>
    pa += PGSIZE;
  }
  return 0;
}
...
80106aed:	68 88 7c 10 80       	push   $0x80107c88
...
80106b1e:	73 5b                	jae    80106b7b <deallocuvm.part.0+0x7b>
80106b20:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
80106b23:	89 d7                	mov    %edx,%edi
80106b25:	eb 14                	jmp    80106b3b <deallocuvm.part.0+0x3b>
80106b27:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106b2e:	66 90                	xchg   %ax,%ax
80106b30:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106b36:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
80106b39:	76 40                	jbe    80106b7b <deallocuvm.part.0+0x7b>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106b3b:	31 c9                	xor    %ecx,%ecx
80106b3d:	89 fa                	mov    %edi,%edx
80106b3f:	89 f0                	mov    %esi,%eax
80106b41:	e8 aa fe ff ff       	call   801069f0 <walkpgdir>
80106b46:	89 c3                	mov    %eax,%ebx
    if(!pte)
80106b48:	85 c0                	test   %eax,%eax
80106b4a:	74 44                	je     80106b90 <deallocuvm.part.0+0x90>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
    else if((*pte & PTE_P) != 0){
80106b4c:	8b 00                	mov    (%eax),%eax
80106b4e:	a8 01                	test   $0x1,%al
80106b50:	74 de                	je     80106b30 <deallocuvm.part.0+0x30>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106b52:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106b57:	74 47                	je     80106ba0 <deallocuvm.part.0+0xa0>
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
80106b59:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
80106b5c:	05 00 00 00 80       	add    $0x80000000,%eax
80106b61:	81 c7 00 10 00 00    	add    $0x1000,%edi
      kfree(v);
80106b67:	50                   	push   %eax
80106b68:	e8 03 b9 ff ff       	call   80102470 <kfree>
      *pte = 0;
80106b6d:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
80106b73:	83 c4 10             	add    $0x10,%esp
  for(; a  < oldsz; a += PGSIZE){
80106b76:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
80106b79:	77 c0                	ja     80106b3b <deallocuvm.part.0+0x3b>
    }
  }
  return newsz;
}
80106b7b:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80106b92:	81 e2 00 00 c0 ff    	and    $0xffc00000,%edx
80106b98:	8d ba 00 00 40 00    	lea    0x400000(%edx),%edi
80106b9e:	eb 96                	jmp    80106b36 <deallocuvm.part.0+0x36>
        panic("kfree");
80106ba0:	83 ec 0c             	sub    $0xc,%esp
80106ba3:	68 a6 75 10 80       	push   $0x801075a6
...
80106bb7:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106bba:	e8 b1 cd ff ff       	call   80103970 <cpuid>
  pd[0] = size-1;
80106bbf:	ba 2f 00 00 00       	mov    $0x2f,%edx
80106bc4:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80106bca:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106bce:	c7 80 f8 27 11 80 ff 	movl   $0xffff,-0x7feed808(%eax)
80106bd5:	ff 00 00 
80106bd8:	c7 80 fc 27 11 80 00 	movl   $0xcf9a00,-0x7feed804(%eax)
80106bdf:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106be2:	c7 80 00 28 11 80 ff 	movl   $0xffff,-0x7feed800(%eax)
80106be9:	ff 00 00 
80106bec:	c7 80 04 28 11 80 00 	movl   $0xcf9200,-0x7feed7fc(%eax)
80106bf3:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106bf6:	c7 80 08 28 11 80 ff 	movl   $0xffff,-0x7feed7f8(%eax)
80106bfd:	ff 00 00 
80106c00:	c7 80 0c 28 11 80 00 	movl   $0xcffa00,-0x7feed7f4(%eax)
80106c07:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106c0a:	c7 80 10 28 11 80 ff 	movl   $0xffff,-0x7feed7f0(%eax)
80106c11:	ff 00 00 
80106c14:	c7 80 14 28 11 80 00 	movl   $0xcff200,-0x7feed7ec(%eax)
80106c1b:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106c1e:	05 f0 27 11 80       	add    $0x801127f0,%eax
  pd[1] = (uint)p;
...
80106c44:	a1 a4 57 11 80       	mov    0x801157a4,%eax
80106c49:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
80106c6a:	83 ec 1c             	sub    $0x1c,%esp
80106c6d:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
80106c70:	85 f6                	test   %esi,%esi
80106c72:	0f 84 cb 00 00 00    	je     80106d43 <switchuvm+0xe3>
  if(p->kstack == 0)
80106c78:	8b 46 08             	mov    0x8(%esi),%eax
80106c7b:	85 c0                	test   %eax,%eax
80106c7d:	0f 84 da 00 00 00    	je     80106d5d <switchuvm+0xfd>
  if(p->pgdir == 0)
80106c83:	8b 46 04             	mov    0x4(%esi),%eax
80106c86:	85 c0                	test   %eax,%eax
80106c88:	0f 84 c2 00 00 00    	je     80106d50 <switchuvm+0xf0>
  pushcli();
80106c8e:	e8 3d d9 ff ff       	call   801045d0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106c93:	e8 68 cc ff ff       	call   80103900 <mycpu>
80106c98:	89 c3                	mov    %eax,%ebx
80106c9a:	e8 61 cc ff ff       	call   80103900 <mycpu>
80106c9f:	89 c7                	mov    %eax,%edi
80106ca1:	e8 5a cc ff ff       	call   80103900 <mycpu>
80106ca6:	83 c7 08             	add    $0x8,%edi
80106ca9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106cac:	e8 4f cc ff ff       	call   80103900 <mycpu>
80106cb1:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106cb4:	ba 67 00 00 00       	mov    $0x67,%edx
80106cb9:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106cc0:	83 c0 08             	add    $0x8,%eax
80106cc3:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106cca:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106ccf:	83 c1 08             	add    $0x8,%ecx
80106cd2:	c1 e8 18             	shr    $0x18,%eax
80106cd5:	c1 e9 10             	shr    $0x10,%ecx
80106cd8:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
80106cde:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80106ce4:	b9 99 40 00 00       	mov    $0x4099,%ecx
80106ce9:	66 89 8b 9d 00 00 00 	mov    %cx,0x9d(%ebx)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106cf0:	bb 10 00 00 00       	mov    $0x10,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
80106cf5:	e8 06 cc ff ff       	call   80103900 <mycpu>
80106cfa:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106d01:	e8 fa cb ff ff       	call   80103900 <mycpu>
80106d06:	66 89 58 10          	mov    %bx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106d0a:	8b 5e 08             	mov    0x8(%esi),%ebx
80106d0d:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106d13:	e8 e8 cb ff ff       	call   80103900 <mycpu>
80106d18:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106d1b:	e8 e0 cb ff ff       	call   80103900 <mycpu>
80106d20:	66 89 78 6e          	mov    %di,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80106d24:	b8 28 00 00 00       	mov    $0x28,%eax
80106d29:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106d2c:	8b 46 04             	mov    0x4(%esi),%eax
80106d2f:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106d34:	0f 22 d8             	mov    %eax,%cr3
}
...
80106d3d:	5d                   	pop    %ebp
  popcli();
80106d3e:	e9 dd d8 ff ff       	jmp    80104620 <popcli>
    panic("switchuvm: no process");
80106d43:	83 ec 0c             	sub    $0xc,%esp
80106d46:	68 8e 7c 10 80       	push   $0x80107c8e
80106d4b:	e8 40 96 ff ff       	call   80100390 <panic>
    panic("switchuvm: no pgdir");
80106d50:	83 ec 0c             	sub    $0xc,%esp
80106d53:	68 b9 7c 10 80       	push   $0x80107cb9
80106d58:	e8 33 96 ff ff       	call   80100390 <panic>
    panic("switchuvm: no kstack");
80106d5d:	83 ec 0c             	sub    $0xc,%esp
80106d60:	68 a4 7c 10 80       	push   $0x80107ca4
80106d65:	e8 26 96 ff ff       	call   80100390 <panic>
...
80106d80:	8b 75 10             	mov    0x10(%ebp),%esi
80106d83:	8b 7d 08             	mov    0x8(%ebp),%edi
80106d86:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80106d89:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106d8f:	77 4b                	ja     80106ddc <inituvm+0x6c>
  mem = kalloc();
80106d91:	e8 9a b8 ff ff       	call   80102630 <kalloc>
  memset(mem, 0, PGSIZE);
80106d96:	83 ec 04             	sub    $0x4,%esp
80106d99:	68 00 10 00 00       	push   $0x1000
  mem = kalloc();
80106d9e:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106da0:	6a 00                	push   $0x0
80106da2:	50                   	push   %eax
80106da3:	e8 38 da ff ff       	call   801047e0 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106da8:	58                   	pop    %eax
80106da9:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106daf:	5a                   	pop    %edx
80106db0:	6a 06                	push   $0x6
80106db2:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106db7:	31 d2                	xor    %edx,%edx
80106db9:	50                   	push   %eax
80106dba:	89 f8                	mov    %edi,%eax
80106dbc:	e8 af fc ff ff       	call   80106a70 <mappages>
  memmove(mem, init, sz);
80106dc1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106dc4:	89 75 10             	mov    %esi,0x10(%ebp)
80106dc7:	83 c4 10             	add    $0x10,%esp
80106dca:	89 5d 08             	mov    %ebx,0x8(%ebp)
80106dcd:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
80106dd6:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106dd7:	e9 a4 da ff ff       	jmp    80104880 <memmove>
    panic("inituvm: more than a page");
80106ddc:	83 ec 0c             	sub    $0xc,%esp
80106ddf:	68 cd 7c 10 80       	push   $0x80107ccd
...
80106dfd:	8b 45 0c             	mov    0xc(%ebp),%eax
80106e00:	8b 75 18             	mov    0x18(%ebp),%esi
  if((uint) addr % PGSIZE != 0)
80106e03:	a9 ff 0f 00 00       	test   $0xfff,%eax
80106e08:	0f 85 99 00 00 00    	jne    80106ea7 <loaduvm+0xb7>
  for(i = 0; i < sz; i += PGSIZE){
80106e0e:	01 f0                	add    %esi,%eax
80106e10:	89 f3                	mov    %esi,%ebx
80106e12:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106e15:	8b 45 14             	mov    0x14(%ebp),%eax
80106e18:	01 f0                	add    %esi,%eax
80106e1a:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
80106e1d:	85 f6                	test   %esi,%esi
80106e1f:	75 15                	jne    80106e36 <loaduvm+0x46>
80106e21:	eb 6d                	jmp    80106e90 <loaduvm+0xa0>
80106e23:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80106e27:	90                   	nop
80106e28:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106e2e:	89 f0                	mov    %esi,%eax
80106e30:	29 d8                	sub    %ebx,%eax
80106e32:	39 c6                	cmp    %eax,%esi
80106e34:	76 5a                	jbe    80106e90 <loaduvm+0xa0>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106e36:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106e39:	8b 45 08             	mov    0x8(%ebp),%eax
80106e3c:	31 c9                	xor    %ecx,%ecx
80106e3e:	29 da                	sub    %ebx,%edx
80106e40:	e8 ab fb ff ff       	call   801069f0 <walkpgdir>
80106e45:	85 c0                	test   %eax,%eax
80106e47:	74 51                	je     80106e9a <loaduvm+0xaa>
    pa = PTE_ADDR(*pte);
...
80106e6b:	ff 75 10             	pushl  0x10(%ebp)
80106e6e:	e8 ed ab ff ff       	call   80101a60 <readi>
80106e73:	83 c4 10             	add    $0x10,%esp
80106e76:	39 f8                	cmp    %edi,%eax
80106e78:	74 ae                	je     80106e28 <loaduvm+0x38>
}
...
{
80106ed0:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(newsz >= KERNBASE)
80106ed3:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106ed6:	85 c0                	test   %eax,%eax
80106ed8:	0f 88 b2 00 00 00    	js     80106f90 <allocuvm+0xd0>
  if(newsz < oldsz)
80106ede:	3b 45 0c             	cmp    0xc(%ebp),%eax
    return oldsz;
80106ee1:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80106ee4:	0f 82 96 00 00 00    	jb     80106f80 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
80106eea:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80106ef0:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80106ef6:	39 75 10             	cmp    %esi,0x10(%ebp)
80106ef9:	77 40                	ja     80106f3b <allocuvm+0x7b>
80106efb:	e9 83 00 00 00       	jmp    80106f83 <allocuvm+0xc3>
    memset(mem, 0, PGSIZE);
80106f00:	83 ec 04             	sub    $0x4,%esp
80106f03:	68 00 10 00 00       	push   $0x1000
80106f08:	6a 00                	push   $0x0
80106f0a:	50                   	push   %eax
80106f0b:	e8 d0 d8 ff ff       	call   801047e0 <memset>
...
80106f24:	e8 47 fb ff ff       	call   80106a70 <mappages>
...
80106f39:	76 48                	jbe    80106f83 <allocuvm+0xc3>
    mem = kalloc();
80106f3b:	e8 f0 b6 ff ff       	call   80102630 <kalloc>
...
80106f49:	68 05 7d 10 80       	push   $0x80107d05
80106f4e:	e8 5d 97 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
80106f65:	e8 96 fb ff ff       	call   80106b00 <deallocuvm.part.0>
      return 0;
...
80106fab:	68 1d 7d 10 80       	push   $0x80107d1d
80106fb0:	e8 fb 96 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
80106fc7:	e8 34 fb ff ff       	call   80106b00 <deallocuvm.part.0>
      kfree(mem);
80106fcc:	83 ec 0c             	sub    $0xc,%esp
80106fcf:	53                   	push   %ebx
80106fd0:	e8 9b b4 ff ff       	call   80102470 <kfree>
      return 0;
...
80106ff7:	8b 55 0c             	mov    0xc(%ebp),%edx
80106ffa:	8b 4d 10             	mov    0x10(%ebp),%ecx
80106ffd:	8b 45 08             	mov    0x8(%ebp),%eax
  if(newsz >= oldsz)
80107000:	39 d1                	cmp    %edx,%ecx
80107002:	73 0c                	jae    80107010 <deallocuvm+0x20>
}
80107004:	5d                   	pop    %ebp
80107005:	e9 f6 fa ff ff       	jmp    80106b00 <deallocuvm.part.0>
...
80107032:	74 55                	je     80107089 <freevm+0x69>
  if(newsz >= oldsz)
80107034:	31 c9                	xor    %ecx,%ecx
80107036:	ba 00 00 00 80       	mov    $0x80000000,%edx
8010703b:	89 f0                	mov    %esi,%eax
8010703d:	89 f3                	mov    %esi,%ebx
8010703f:	e8 bc fa ff ff       	call   80106b00 <deallocuvm.part.0>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80107044:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
8010704a:	eb 0b                	jmp    80107057 <freevm+0x37>
...
8010706e:	e8 fd b3 ff ff       	call   80102470 <kfree>
...
80107083:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107084:	e9 e7 b3 ff ff       	jmp    80102470 <kfree>
    panic("freevm: no pgdir");
...
801070a7:	56                   	push   %esi
801070a8:	53                   	push   %ebx
  if((pgdir = (pde_t*)kalloc()) == 0)
801070a9:	e8 82 b5 ff ff       	call   80102630 <kalloc>
801070ae:	89 c6                	mov    %eax,%esi
801070b0:	85 c0                	test   %eax,%eax
801070b2:	74 42                	je     801070f6 <setupkvm+0x56>
  memset(pgdir, 0, PGSIZE);
801070b4:	83 ec 04             	sub    $0x4,%esp
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801070b7:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
  memset(pgdir, 0, PGSIZE);
801070bc:	68 00 10 00 00       	push   $0x1000
801070c1:	6a 00                	push   $0x0
801070c3:	50                   	push   %eax
801070c4:	e8 17 d7 ff ff       	call   801047e0 <memset>
801070c9:	83 c4 10             	add    $0x10,%esp
                (uint)k->phys_start, k->perm) < 0) {
801070cc:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
801070cf:	83 ec 08             	sub    $0x8,%esp
801070d2:	8b 4b 08             	mov    0x8(%ebx),%ecx
801070d5:	ff 73 0c             	pushl  0xc(%ebx)
801070d8:	8b 13                	mov    (%ebx),%edx
801070da:	50                   	push   %eax
801070db:	29 c1                	sub    %eax,%ecx
801070dd:	89 f0                	mov    %esi,%eax
801070df:	e8 8c f9 ff ff       	call   80106a70 <mappages>
801070e4:	83 c4 10             	add    $0x10,%esp
801070e7:	85 c0                	test   %eax,%eax
801070e9:	78 15                	js     80107100 <setupkvm+0x60>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801070eb:	83 c3 10             	add    $0x10,%ebx
801070ee:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
801070f4:	75 d6                	jne    801070cc <setupkvm+0x2c>
}
801070f6:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
80107127:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
8010712a:	e8 71 ff ff ff       	call   801070a0 <setupkvm>
8010712f:	a3 a4 57 11 80       	mov    %eax,0x801157a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80107134:	05 00 00 00 80       	add    $0x80000000,%eax
80107139:	0f 22 d8             	mov    %eax,%cr3
}
8010713c:	c9                   	leave  
8010713d:	c3                   	ret    
...
80107152:	e8 99 f8 ff ff       	call   801069f0 <walkpgdir>
  if(pte == 0)
80107157:	85 c0                	test   %eax,%eax
80107159:	74 05                	je     80107160 <clearpteu+0x20>
    panic("clearpteu");
  *pte &= ~PTE_U;
8010715b:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
8010715e:	c9                   	leave  
8010715f:	c3                   	ret    
    panic("clearpteu");
80107160:	83 ec 0c             	sub    $0xc,%esp
80107163:	68 4a 7d 10 80       	push   $0x80107d4a
...
8010717a:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
8010717d:	e8 1e ff ff ff       	call   801070a0 <setupkvm>
80107182:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107185:	85 c0                	test   %eax,%eax
80107187:	0f 84 9b 00 00 00    	je     80107228 <copyuvm+0xb8>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
8010718d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80107190:	85 c9                	test   %ecx,%ecx
80107192:	0f 84 90 00 00 00    	je     80107228 <copyuvm+0xb8>
80107198:	31 f6                	xor    %esi,%esi
8010719a:	eb 46                	jmp    801071e2 <copyuvm+0x72>
...
801071e9:	e8 02 f8 ff ff       	call   801069f0 <walkpgdir>
...
801071ff:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80107202:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107208:	e8 23 b4 ff ff       	call   80102630 <kalloc>
8010720d:	89 c3                	mov    %eax,%ebx
...
80107219:	e8 02 fe ff ff       	call   80107020 <freevm>
  return 0;
8010721e:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
80107272:	e8 79 f7 ff ff       	call   801069f0 <walkpgdir>
  if((*pte & PTE_P) == 0)
80107277:	8b 00                	mov    (%eax),%eax
    return 0;
  if((*pte & PTE_U) == 0)
    return 0;
...
80107279:	c9                   	leave  
  if((*pte & PTE_U) == 0)
8010727a:	89 c2                	mov    %eax,%edx
  return (char*)P2V(PTE_ADDR(*pte));
8010727c:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((*pte & PTE_U) == 0)
80107281:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
80107284:	05 00 00 00 80       	add    $0x80000000,%eax
80107289:	83 fa 05             	cmp    $0x5,%edx
8010728c:	ba 00 00 00 00       	mov    $0x0,%edx
80107291:	0f 45 c2             	cmovne %edx,%eax
}
80107294:	c3                   	ret    
...
801072ad:	8b 75 14             	mov    0x14(%ebp),%esi
801072b0:	8b 55 0c             	mov    0xc(%ebp),%edx
  ...
  buf = (char*)p;
  while(len > 0){
801072b3:	85 f6                	test   %esi,%esi
801072b5:	75 3c                	jne    801072f3 <copyout+0x53>
801072b7:	eb 67                	jmp    80107320 <copyout+0x80>
801072b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
801072c0:	8b 55 0c             	mov    0xc(%ebp),%edx
801072c3:	89 fb                	mov    %edi,%ebx
801072c5:	29 d3                	sub    %edx,%ebx
801072c7:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
801072cd:	39 f3                	cmp    %esi,%ebx
801072cf:	0f 47 de             	cmova  %esi,%ebx
      n = len;
    memmove(pa0 + (va - va0), buf, n);
801072d2:	29 fa                	sub    %edi,%edx
801072d4:	83 ec 04             	sub    $0x4,%esp
801072d7:	01 c2                	add    %eax,%edx
801072d9:	53                   	push   %ebx
801072da:	ff 75 10             	pushl  0x10(%ebp)
801072dd:	52                   	push   %edx
801072de:	e8 9d d5 ff ff       	call   80104880 <memmove>
    len -= n;
    buf += n;
801072e3:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
801072e6:	8d 97 00 10 00 00    	lea    0x1000(%edi),%edx
  while(len > 0){
801072ec:	83 c4 10             	add    $0x10,%esp
801072ef:	29 de                	sub    %ebx,%esi
801072f1:	74 2d                	je     80107320 <copyout+0x80>
    va0 = (uint)PGROUNDDOWN(va);
801072f3:	89 d7                	mov    %edx,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
801072f5:	83 ec 08             	sub    $0x8,%esp
    va0 = (uint)PGROUNDDOWN(va);
801072f8:	89 55 0c             	mov    %edx,0xc(%ebp)
801072fb:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
80107301:	57                   	push   %edi
80107302:	ff 75 08             	pushl  0x8(%ebp)
80107305:	e8 56 ff ff ff       	call   80107260 <uva2ka>
    if(pa0 == 0)
8010730a:	83 c4 10             	add    $0x10,%esp
8010730d:	85 c0                	test   %eax,%eax
8010730f:	75 af                	jne    801072c0 <copyout+0x20>
  }
  return 0;
}
80107311:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
