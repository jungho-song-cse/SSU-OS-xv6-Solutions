...
int main(int argc, char *argv[]){
  ...
  15:	68 58 07 00 00       	push   $0x758
  1a:	6a 01                	push   $0x1
  1c:	e8 cf 03 00 00       	call   3f0 <printf>
	exit();
 ...
 34c:	89 d1                	mov    %edx,%ecx
{
 ...
 379:	0f b6 92 70 07 00 00 	movzbl 0x770(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 574:	eb 1a                	jmp    590 <printf+0x1a0>
          s = "(null)";
 576:	bb 69 07 00 00       	mov    $0x769,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c5:	a1 18 0a 00 00       	mov    0xa18,%eax
{
 ...
 5e6:	73 10                	jae    5f8 <free+0x38>
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	a3 18 0a 00 00       	mov    %eax,0xa18
}
 617:	5e                   	pop    %esi
 618:	5f                   	pop    %edi
 619:	5d                   	pop    %ebp
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 18 0a 00 00       	mov    %eax,0xa18
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 65d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 660:	8b 3d 18 0a 00 00    	mov    0xa18,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6a9:	8b 3d 18 0a 00 00    	mov    0xa18,%edi
 ...
 6d2:	e8 e9 fe ff ff       	call   5c0 <free>
  return freep;
 6d7:	a1 18 0a 00 00       	mov    0xa18,%eax
 ...
 704:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 707:	a3 18 0a 00 00       	mov    %eax,0xa18
}
 ...
 71e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 18 0a 00 00 1c 	movl   $0xa1c,0xa18
 727:	0a 00 00 
    base.s.size = 0;
 72a:	bf 1c 0a 00 00       	mov    $0xa1c,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 1c 0a 00 00 1c 	movl   $0xa1c,0xa1c
 736:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 73b:	c7 05 20 0a 00 00 00 	movl   $0x0,0xa20
 742:	00 00 00 
    if(p->s.size >= nunits){
