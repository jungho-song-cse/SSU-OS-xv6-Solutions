...
6960 
6961   // Mark all interrupts edge-triggered, active high, disabled,
6962   // and not routed to any CPUs.
...
6971 {
6972   // Mark interrupt edge-triggered, active high,
6973   // enabled, and routed to the given cpunum,
6974   // which happens to be that cpu's APIC ID.
