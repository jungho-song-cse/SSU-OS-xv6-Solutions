...
main(void)
{
  ...
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 30 0b 00 00       	push   $0xb30
  ab:	68 49 08 00 00       	push   $0x849
  b0:	e8 d6 02 00 00       	call   38b <exec>
      printf(1, "init: exec ssu_login failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 53 08 00 00       	push   $0x853
  bc:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 634:	eb 1a                	jmp    650 <printf+0x1a0>
          s = "(null)";
 636:	bb 7c 08 00 00       	mov    $0x87c,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 71d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 720:	8b 3d 38 0b 00 00    	mov    0xb38,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
